"""
kogutext アウトリーチ送信スクリプト（Gmail SMTP・30件/日）
"""
import argparse
import csv
import os
...
_COMPANY_REQUIRED = ['機械工具', '産業機械', '工具商', '金物', '専門商社', '卸売', '販売', '工作機械', '切削工具', '測定工具', '電動工具', '油圧機器', '空圧機器', '研磨材', '溶接機', '作業工具', '伝導機器', '配管材料', '工場設備']
_BLOG_SIGNALS = ['コツ', '選び方', 'ランキング', '比較', 'まとめ', '一覧', '営業リスト', '効率化', '課題', '改善']
