"""
kogutext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['機械工具', '産業機械', '工具商', '金物', '専門商社', '卸売', '販売', '工作機械', '切削工具', '測定工具', '電動工具', '油圧機器', '空圧機器', '研磨材', '溶接機', '作業工具', '伝導機器', '配管材料', '工場設備']

QUERIES = ['"機械工具卸売業者" "お問い合わせ" site:co.jp -求人', '"産業機械商社" "info@" site:co.jp -採用', '"工具販売店" "メールでのお問い合わせ" site:jp -転職', '"切削工具 卸" "連絡先" site:co.jp -募集', '"測定工具 専門商社" "お問い合わせフォーム" site:co.jp -キャリア', '"電動工具 卸売" "法人向け" "連絡先" site:jp', '"油圧機器 販売" "営業部" "お問い合わせ" site:co.jp', '"空圧機器 専門" "メールアドレス" site:co.jp -リクルート', '"研磨材 卸" "法人営業" "お問い合わせ" site:jp', '"工作機械 代理店" "お問い合わせ" site:co.jp -求人', '"溶接機 卸売" "法人様" "連絡先" site:co.jp', '"作業工具 専門" "info@" site:jp -採用', '"伝導機器 商社" "お問い合わせ" site:co.jp -求人', '"配管材料 卸" "メールアドレス" site:jp -募集', '"工場設備 卸売" "法人向け" "お問い合わせ" site:co.jp']
