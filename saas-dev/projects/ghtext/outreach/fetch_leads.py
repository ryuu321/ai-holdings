"""
ghtext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['グループホーム', '認知症対応型共同生活介護', '介護', '福祉', 'ケア', 'ホーム', '苑', '園']

QUERIES = ['グループホーム 問い合わせ メール site:co.jp -求人 -採用', '認知症対応型共同生活介護 連絡先 site:co.jp -転職 -募集', '社会福祉法人 グループホーム 事務長 連絡先 site:jp -採用', '株式会社 介護施設 経営者 問い合わせ site:co.jp -募集', 'グループホーム 施設長 メールアドレス site:co.jp -求人', '認知症グループホーム 運営法人 連絡先 site:jp -採用情報', '介護事業所 問い合わせフォーム site:co.jp -求人', 'グループホーム サービス内容 連絡先 site:jp -採用', '地域密着型サービス 問い合わせ先 site:co.jp -募集', 'グループホーム 施設概要 連絡先 site:jp -求人', '認知症ケア 施設 問い合わせ site:co.jp -採用', '介護施設 経営企画 連絡先 site:jp -求人', 'グループホーム 運営会社 問い合わせ site:co.jp -採用', '高齢者施設 連絡先 メール site:jp -求人', '認知症グループホーム 施設情報 問い合わせ site:co.jp -採用']
