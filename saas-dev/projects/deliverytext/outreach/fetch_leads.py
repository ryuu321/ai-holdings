"""
deliverytext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['宅配', 'デリバリー', '配送', '運送', 'フード', 'ネットスーパー', '加盟店', 'フランチャイズ']

QUERIES = ['宅配 デリバリー 加盟店 問い合わせ site:co.jp -求人', 'フードデリバリー 加盟店 連絡先 site:jp -採用', 'ネットスーパー 配送 会社 連絡先 site:co.jp -転職', '宅配サービス 事業者 お問い合わせ site:jp -募集', 'デリバリー専門店 運営会社 info@ site:co.jp', '宅配弁当 サービス 企業 お問い合わせ site:jp', '物流 配送 業者 連絡先 site:co.jp -求人', 'ラストワンマイル 配送 企業 お問い合わせ site:jp', 'フードデリバリー フランチャイズ 運営会社 連絡先 site:co.jp', '宅配飲食 チェーン 本部 お問い合わせ site:jp', '生協 宅配 サービス 連絡先 site:co.jp', '酒類 宅配 業者 お問い合わせ site:jp', '医薬品 宅配 サービス 企業 連絡先 site:co.jp', '宅配クリーニング サービス 運営会社 お問い合わせ site:jp', '地域密着型 デリバリー 会社 連絡先 site:co.jp']
