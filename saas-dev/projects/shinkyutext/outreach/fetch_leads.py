"""
shinkyutext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['鍼灸', 'はり', 'きゅう', '治療院', '整骨院', '接骨院', '東洋医学']

QUERIES = ['鍼灸院 "お問い合わせ" site:co.jp -求人 -採用', '鍼灸院 "info@" site:jp -求人 -採用', '鍼灸院 "メールでのお問い合わせ" site:co.jp -転職 -募集', '鍼灸院 "ご予約・お問い合わせ" site:jp -採用情報', '鍼灸院 "連絡先" site:co.jp -求人 -ブログ', '東京都 鍼灸院 "お問い合わせ" site:jp', '大阪府 鍼灸院 "メール" site:co.jp', '美容鍼灸院 "お問い合わせ" site:jp', 'スポーツ鍼灸院 "info@" site:co.jp', '女性専門 鍼灸院 "連絡先" site:jp', '小児鍼 "お問い合わせ" site:co.jp', '不妊鍼灸 "メール" site:jp', '鍼灸整骨院 "お問い合わせ" site:co.jp -求人', 'はりきゅう院 "info@" site:jp -採用', '鍼灸治療院 "お問い合わせ" site:co.jp -募集']
