"""
hakentext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['人材派遣', '人材紹介', 'アウトソーシング', 'HR', 'ワーク', 'スタッフ', 'キャリア', 'ヒューマン']

QUERIES = ['"人材派遣会社" "お問い合わせ" site:co.jp -求人 -採用', '"人材派遣" "info@" site:co.jp -採用 -転職', '"派遣会社" "メールアドレス" site:co.jp -転職 -求人', '"人材紹介" "会社概要" "連絡先" site:co.jp', '"人材サービス" "代表メール" site:co.jp -採用', '"労働者派遣事業" "お問い合わせフォーム" site:co.jp', '"派遣元責任者" "連絡先" site:co.jp', '"派遣先管理台帳" "お問い合わせ" site:co.jp -求人', '"人材派遣" "法人向け" "連絡先" site:co.jp', '"派遣事業" "ご相談" site:co.jp -求人', '"人材派遣" "パートナー募集" "お問い合わせ" site:co.jp', '"人材派遣" "ソリューション" "連絡先" site:co.jp', '"総合人材サービス" "法人のお客様" "お問い合わせ" site:co.jp', '"人材派遣" "営業担当" "連絡先" site:co.jp', '"派遣会社" "サービス内容" "お問い合わせ" site:co.jp -求人']
