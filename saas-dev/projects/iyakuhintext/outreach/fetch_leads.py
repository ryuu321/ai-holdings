"""
iyakuhintext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['医薬品', '医療用', '製薬', '流通', '卸売', 'メディカル', 'ファーマ']

QUERIES = ['医薬品卸売業者 "お問い合わせ" site:co.jp -求人 -採用', '医薬品卸売業 "info@" site:jp -転職 -採用', '医薬品卸売会社 "メールでのお問い合わせ" -採用情報', '医療用医薬品 卸売 "連絡先" site:co.jp', '医薬品流通 "お問い合わせフォーム" -求人', '医薬品卸 "代表電話" site:jp', '医薬品卸売業 "営業部" 連絡先 メール', '医薬品卸売業 "事業内容" 問い合わせ先', '医薬品卸売業 "企業情報" メールアドレス', '医薬品卸売業 "パートナー募集" 連絡先', '医薬品卸売業 "新規取引" 問い合わせ', '医薬品卸売業 "資料請求" メールアドレス', '医薬品卸売業 "法人向け" 連絡先', '医薬品卸売業 "ソリューション" 問い合わせ', '医薬品卸売業 "事業提携" 連絡先']
