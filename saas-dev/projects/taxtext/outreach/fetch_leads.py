...
SITE_SKIP = ["wikipedia", "google", "yahoo", "twitter", "facebook", "instagram",
             ...
             "zeiri4.com", "zeirishinet.com", "kachiel.com"]

_COMPANY_KEYWORDS = ["税理士", "税理士事務所", "税理士法人", "会計事務所", "会計"]

QUERIES = [
    '税理士事務所 "お問い合わせ" site:co.jp -求人',
    '税理士法人 "メールでのお問い合わせ" -採用 -求人',
    '税理士 "info@" site:co.jp -求人',
    '会計事務所 税理士 "お問い合わせ" -ランキング',
    '税理士事務所 経営計画書 "メール" -求人',
    '税理士 東京 "お問い合わせ" site:co.jp',
    '税理士法人 大阪 "info@" -求人',
    '税理士 名古屋 "メール" site:co.jp',
    '税理士 福岡 "お問い合わせ" -採用',
    '税理士 神奈川 "contact@" site:co.jp',
    '税理士 埼玉 "info@" -求人',
    '税理士 千葉 "メール" site:co.jp',
    '税理士事務所 融資支援 "お問い合わせ" -一覧',
    '税理士 中小企業 経営計画 "info@" site:co.jp',
    '税理士 法人税 確定申告 "お問い合わせ" -ランキング',
    '税理士 創業融資 "メール" -求人',
    '税理士 相続 事業承継 "お問い合わせ" site:co.jp',
    '会計事務所 税務顧問 "contact" site:co.jp',
    '税理士事務所 開業 "お問い合わせ" -一覧',
    '税理士 北海道 "info@" -求人',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; TaxTextBot/1.0)"})
