"""
salontext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['美容室', 'ヘアサロン', '美容院', 'HAIR SALON', 'ビューティーサロン', '理容室']

QUERIES = ['美容室 "お問い合わせ" site:co.jp -求人 -採用', 'ヘアサロン "info@" site:co.jp -転職 -リクルート', '美容院 "メールでのお問い合わせ" site:co.jp -採用 -求人', 'サロン "連絡先" site:co.jp -転職 -リクルート', '美容室 経営者 "問い合わせ" site:co.jp -求人', 'ヘアサロン オーナー "お問い合わせ" site:co.jp -転職', '美容院 サイトマップ site:co.jp -求人 -採用', '美容室 会社概要 site:co.jp -転職 -リクルート', 'ヘアサロン 業務提携 "連絡先" site:co.jp -求人', '美容院 広報 "メールアドレス" site:co.jp -採用', '美容室 新規オープン "お問い合わせ" site:co.jp -求人', 'ヘアサロン 採用情報 "連絡先" site:co.jp -転職 (代表アドレス取得目的)', '美容院 プレスリリース "問い合わせ" site:co.jp -求人', '美容室 法人向け "お問い合わせ" site:co.jp -採用', 'ヘアサロン サイト運営者 "連絡先" site:co.jp -転職']
