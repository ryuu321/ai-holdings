"""
braidaltext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['ウェディング', 'ブライダル', '結婚式', 'ゲストハウス', 'ホテル', 'マリアージュ']

QUERIES = ['ブライダル会社 "お問い合わせ" site:co.jp -求人', 'ウェディングプランナー "採用" site:co.jp -求人', '結婚式場 "連絡先" site:co.jp -採用', 'ゲストハウスウェディング "問い合わせ" site:co.jp -求人', 'ホテルブライダル "担当者" site:co.jp -採用', 'ウェディングプロデュース会社 "連絡先" site:co.jp -求人', 'ブライダルフェア "問い合わせ" site:co.jp -採用', '結婚式 "相談会" "連絡先" site:co.jp -求人', 'ウェディングコンサルティング "問い合わせ" site:co.jp -採用', 'ブライダルサービス企業 "お問い合わせ" site:co.jp -求人', '結婚式プロデュース会社 "メール" site:co.jp -採用', 'ウェディング企画会社 "連絡先" site:co.jp -求人', 'ブライダル運営会社 "お問い合わせ" site:co.jp -採用', 'リゾートウェディング会社 "info@" site:co.jp -求人', 'オリジナルウェディング会社 "contact" site:co.jp -採用']
