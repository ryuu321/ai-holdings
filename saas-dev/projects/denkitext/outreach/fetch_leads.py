...
SITE_SKIP = ["wikipedia", "google", "yahoo", "twitter", "facebook", "instagram",
             ...
             "denki-navi", "denkikoji"]

_COMPANY_KEYWORDS = ["電気工事", "電設", "電機工事", "設備工事", "電気設備"]

QUERIES = [
    '電気工事 "お問い合わせ" site:co.jp -求人',
    '電設工業 "メールでのお問い合わせ" -採用 -求人',
    '電気工事 "info@" site:co.jp -ランキング',
    '設備工事 "お問い合わせ" -一覧 -比較',
    '電気工事 "contact@" site:co.jp',
    '電気設備 "メール" 工事 -求人 -ランキング',
    '電気工事 東京 "お問い合わせ" site:co.jp -求人',
    '電設工業 大阪 "info@" -採用',
    '電気工事 名古屋 "メール" site:co.jp',
    '電気設備 神奈川 "お問い合わせ" -求人',
    '電気工事 福岡 "contact@" site:co.jp',
    '電設工業 埼玉 "info@" -採用 -一覧',
    '電気工事業者 "完了報告" "お問い合わせ" site:co.jp',
    '電気設備工事 "メール" -求人',
    '電気工事 受変電 "お問い合わせ" -ランキング',
    '電設 幹線工事 "info@" site:co.jp',
    '電気工事業 "ご連絡" "メール" site:co.jp -まとめ',
    '設備工事 電気 "お問い合わせ" -一覧',
    '電気工事 "info@" site:co.jp -求人',
    '電設工業 "お問い合わせ" site:co.jp',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; DenkiTextBot/1.0)"})
