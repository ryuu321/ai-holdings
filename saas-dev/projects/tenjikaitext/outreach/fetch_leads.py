"""
tenjikaitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['展示会', '見本市', 'イベント', 'コンベンション', 'EXPO', 'トレードショー', '事務局', '運営', '企画']

QUERIES = ['展示会運営会社 問い合わせ site:co.jp -求人', 'イベント主催会社 連絡先 site:co.jp -採用', '見本市 企画 会社 メールアドレス site:co.jp', 'コンベンションビューロー 担当者 連絡先', 'トレードショー 運営 企業 問い合わせ', '展示会事務局 連絡先 site:co.jp', 'イベントプロデュース 会社 問い合わせ', 'イベントマネジメント 企業 連絡先', '展示会 企画 運営 会社 "info@" site:co.jp', '見本市 事務局 連絡先 site:or.jp', '展示会 運営 サービス 問い合わせ', 'イベント開催 支援 会社 連絡先', 'コンベンション 運営 会社 問い合わせ', '展示会 運営 代行 会社 連絡先', 'イベント企画 制作 会社 問い合わせ']
