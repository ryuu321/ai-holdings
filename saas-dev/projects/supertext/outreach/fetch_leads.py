"""
supertext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['スーパー', '食品', 'マーケット', 'ストア', '生鮮', '青果', '精肉', '鮮魚', '惣菜', 'デリ']

QUERIES = ['地場スーパー お問い合わせ site:co.jp -求人 -採用', '食品小売 連絡先 メール site:jp', '生鮮食品店 業者募集 問い合わせ', '地域密着スーパー 経営者 連絡先', '食品スーパー 卸売 担当者 メール', '精肉店 問い合わせフォーム site:co.jp', '鮮魚店 業務提携 連絡先', '惣菜店 パートナー募集 メールアドレス', '地域スーパー 経営企画部 連絡先', '食品販売店 品質管理 問い合わせ', '道の駅 出店者募集 連絡先 メール', '直売所 運営会社 問い合わせ先', '地場スーパー 仕入れ担当 連絡先', '食品小売 経営戦略 問い合わせ', '食料品店 業務改善 相談']
