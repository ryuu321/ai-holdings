"""
月額SaaS・サブスクサービス運営会社のリードをBrave APIで収集
...
SITE_SKIP = ["wikipedia", "google", "yahoo", "twitter", "facebook", "instagram",
             ...
             "qiita.com", "zenn.dev", "note.com", "hatena"]

_COMPANY_KEYWORDS = ["株式会社", "有限会社", "合同会社"]

QUERIES = [
    '月額 SaaS 株式会社 "お問い合わせ" site:co.jp -求人',
    'サブスクリプション サービス 株式会社 "info@" -求人',
    'クラウドサービス 株式会社 "メール" お問い合わせ site:co.jp',
    '月額課金 サービス 株式会社 "contact@" -採用',
    'サブスク 会員 株式会社 "お問い合わせ" -ランキング',
    '業務管理 クラウド 株式会社 "info@" site:co.jp',
    'ビジネス SaaS 株式会社 東京 "メール" -求人',
    '顧客管理 システム 株式会社 "お問い合わせ" -求人',
    'プロジェクト管理 クラウド 株式会社 "contact" site:co.jp',
    'HR テック 株式会社 "お問い合わせ" -採用',
    '会計 クラウド 株式会社 "info@" site:co.jp',
    '在庫管理 SaaS 株式会社 "メール" -求人',
    '予約管理 サービス 株式会社 "お問い合わせ" site:co.jp',
    'マーケティング オートメーション 株式会社 "contact@"',
    '受発注 クラウド 株式会社 "お問い合わせ" -採用',
    '経費精算 SaaS 株式会社 "info@" -求人',
    '労務管理 クラウド 株式会社 "メール" site:co.jp',
    'ECシステム 月額 株式会社 "お問い合わせ"',
    'ヘルスケア アプリ 株式会社 "contact" -採用',
    '教育 eラーニング 株式会社 "info@" site:co.jp',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; ChurnTextBot/1.0)"})
