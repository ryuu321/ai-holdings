"""
naisotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['内装', 'リフォーム', '改修', '店舗', 'オフィス', '住宅', 'デザイン', '工務店', '建設']

QUERIES = ['内装工事会社 "お問い合わせ" site:co.jp -求人', 'リフォーム業者 "info@" -採用 site:jp', '店舗内装 "メールでのお問い合わせ" -転職 site:com', 'オフィス内装 "contact" site:co.jp -募集', '住宅リノベーション "お問い合わせフォーム" site:jp -求人', '内装デザイン事務所 "メールアドレス" -採用 site:co.jp', '建設会社 内装部門 "連絡先" -転職 site:jp', '原状回復工事 "お問い合わせ先" site:co.jp -求人', 'マンションリフォーム "メール" site:jp -採用', '商業施設内装 "お問い合わせ" site:com -求人', '病院内装 "info@" site:co.jp -採用', 'ホテル内装 "メールでのお問い合わせ" site:jp -転職', '学校内装 "contact" site:co.jp -募集', '工場内装 "お問い合わせフォーム" site:jp -求人', 'オフィスデザイン "メールアドレス" site:co.jp -採用']
