"""
shokuhintext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['食品', 'フーズ', '製菓', '加工', '乳業', 'ミート', '水産', '飲料', '酒造', '工場', '製造', 'プロダクト']

QUERIES = ['食品製造業 "お問い合わせ" site:co.jp -求人', '食品加工 "info@" -採用', 'HACCP "連絡先" site:jp -転職', '食品工場 "メールアドレス" -募集', '品質管理 "お問い合わせフォーム" site:co.jp', '衛生管理 "連絡先" site:jp -求人', '異物混入 "報告書" "お問い合わせ"', '食品安全 "コンタクト" site:co.jp', '製造業 "食品" "お問い合わせ" site:jp', '菓子製造 "info@" -採用', '食肉加工 "お問い合わせ" site:co.jp -求人', '乳製品製造 "連絡先" site:jp', '飲料製造 "メール" site:co.jp', '惣菜製造 "お問い合わせ" -求人', '食品製造 "担当者" "連絡先"']
