"""
reizotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['冷凍', '冷蔵', 'チルド', 'フローズン', 'コールドチェーン', '定温', '低温', '食品物流', '水産', '農産']

QUERIES = ['"冷凍倉庫" "お問い合わせ" site:co.jp -求人', '"冷蔵倉庫" "info@" -採用', '"物流倉庫" "メールでのお問い合わせ" -転職', '"コールドチェーン" "連絡先" site:co.jp', '"食品物流" "お問い合わせフォーム"', '"HACCP" "冷凍冷蔵倉庫" "連絡先"', '"温度管理" "倉庫" "お問い合わせ" site:co.jp', '"チルド倉庫" "info@" -採用', '"フローズン倉庫" "お問い合わせ" site:co.jp', '"水産物 冷凍倉庫" "連絡先"', '"農産物 冷蔵倉庫" "お問い合わせ"', '"倉庫業" "お問い合わせ" site:co.jp -求人', '"定温倉庫" "info@"', '"保税倉庫" "お問い合わせ" site:co.jp', '"冷凍冷蔵倉庫" "品質管理" "お問い合わせ" site:co.jp']
