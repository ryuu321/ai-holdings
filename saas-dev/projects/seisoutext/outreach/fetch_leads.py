"""
seisoutext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['ビルメンテナンス', '環境衛生', 'クリーン', 'プロパティ', '施設管理', '美装', '清掃サービス', 'ビル管', '衛生管理']

QUERIES = ['"清掃会社" "お問い合わせ" site:co.jp -求人 -採用 -転職', '"ビルメンテナンス" "連絡先" site:co.jp -求人 -採用 -転職', '"オフィス清掃" "見積もり" site:co.jp -求人 -採用 -転職', '"病院清掃" "法人" "問い合わせ" site:co.jp -求人 -採用 -転職', '"商業施設清掃" "業務委託" "連絡先" site:co.jp -求人 -採用 -転職', '"環境衛生管理" "パートナー" "お問い合わせ" site:co.jp -求人 -採用 -転職', '"定期清掃" "業者" "メール" site:co.jp -求人 -採用 -転職', '"特殊清掃" "法人向け" "問い合わせ" site:co.jp -求人 -採用 -転職', '"マンション清掃" "管理組合" "連絡先" site:co.jp -求人 -採用 -転職', '"工場清掃" "サービス" "お問い合わせ" site:co.jp -求人 -採用 -転職', '"清掃業務" "法人" "コンタクト" site:co.jp -求人 -採用 -転職', '"ハウスクリーニング" "法人契約" "問い合わせ" site:co.jp -求人 -採用 -転職', '"クリーンサービス" "企業" "連絡先" site:co.jp -求人 -採用 -転職', '"施設清掃" "専門" "お問い合わせ" site:co.jp -求人 -採用 -転職', '"美装工事" "法人" "連絡先" site:co.jp -求人 -採用 -転職']
