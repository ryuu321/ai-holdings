"""
kanteitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['不動産鑑定', '鑑定評価', '不動産コンサルティング', '不動産調査']

QUERIES = ['不動産鑑定士事務所 連絡先 site:co.jp -求人 -採用', '不動産鑑定事務所 メールアドレス site:jp -転職 -募集', '不動産鑑定評価 依頼 お問い合わせ site:co.jp -ランキング', '不動産鑑定コンサルティング 相談 メール site:jp -比較', '土地評価 専門家 お問い合わせフォーム site:co.jp -ブログ', '相続不動産 鑑定 連絡先 site:jp -セミナー', 'M&A 不動産評価 info@ site:co.jp -記事', '担保評価 不動産 お問い合わせ site:jp -コラム', '不動産鑑定士 事務所一覧 メール site:co.jp -まとめ', '不動産鑑定法人 問い合わせ site:jp -wiki', '不動産鑑定士 業務内容 連絡先 site:co.jp -資格', '不動産鑑定士 費用 お問い合わせ site:jp -相場', '不動産鑑定士 サービス メール site:co.jp -料金', '不動産鑑定士 事務所 東京 お問い合わせ site:jp -地図', '不動産鑑定士 事務所 大阪 メール site:co.jp -アクセス']
