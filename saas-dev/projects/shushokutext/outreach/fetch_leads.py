"""
shushokutext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['人材紹介', 'キャリア支援', '就職支援', '転職エージェント', '人材サービス', 'キャリアコンサルティング']

QUERIES = ['就職支援会社 "お問い合わせ" site:co.jp -求人', '人材紹介会社 "info@" -採用', 'キャリアコンサルティング "メールでのお問い合わせ" -転職', '就職支援サービス "contact@" site:jp -求人', '人材派遣会社 "お問い合わせ" site:co.jp -採用', 'キャリア支援 "info@" -転職', '就職エージェント "お問い合わせ" site:jp -求人', '若年層 就職支援 "メール" site:co.jp', '外国人材 就職支援 "お問い合わせ" site:jp', '第二新卒 就職支援 "info@" site:co.jp', '障がい者 就職支援 "お問い合わせ" site:jp', 'ミドル層 キャリア支援 "メール" site:co.jp', '人材紹介 "資料請求" site:jp', 'キャリアアドバイザー "お問い合わせ" site:co.jp', '人材コンサルティング "info@" site:jp']
