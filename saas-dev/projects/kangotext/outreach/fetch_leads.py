"""
kangotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['訪問看護', '在宅ケア', '地域医療', 'リハビリ', 'ケア', 'ステーション', 'クリニック', '医療法人', '株式会社']

QUERIES = ['訪問看護ステーション "お問い合わせ" site:co.jp -求人', '訪問看護ステーション "info@" -採用', '訪問看護ステーション "メールでのお問い合わせ" -転職', '"株式会社" "訪問看護" "連絡先" site:co.jp', '"医療法人" "訪問看護" "お問い合わせ" site:jp', '"地域" "訪問看護ステーション" "メールアドレス" site:jp', '"訪問看護" "会社概要" "連絡先" site:co.jp', '"在宅ケア" "事業所" "お問い合わせ" site:jp', '"訪問看護" "管理者" "連絡先" site:co.jp', '"訪問看護" "経営者" "メール" site:jp', '"訪問看護" "採用情報" "連絡先" site:co.jp', '"訪問看護" "提携" "お問い合わせ" site:jp', '"訪問看護" "連携" "連絡先" site:co.jp', '"訪問看護" "サービス内容" "連絡先" site:jp', '"訪問看護" "法人" "お問い合わせ" site:co.jp']
