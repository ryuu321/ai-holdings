"""
unsotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['運輸', '運送', '物流', '貨物', '通運', '配送', '陸運', '急送', '輸送']

QUERIES = ['運送会社 "お問い合わせ" site:co.jp -求人 -採用', '運送会社 "info@" site:co.jp -転職 -募集', '運送会社 "メールでのお問い合わせ" site:jp -採用情報', '貨物輸送 "連絡先" site:co.jp -求人', '物流会社 "問い合わせフォーム" site:jp -キャリア', '配送業者 "法人向け" "お問い合わせ" site:co.jp', 'トラック運送 "お問い合わせ" site:jp -ドライバー募集', '冷凍輸送 "連絡先" site:co.jp', '重量物輸送 "問い合わせ" site:jp', '倉庫業 "お問い合わせ" site:co.jp -パート', '陸運業 "連絡先" site:jp -アルバイト', 'チャーター便 "お問い合わせ" site:co.jp', '緊急輸送 "連絡先" site:jp', '運送事業協同組合 "お問い合わせ" site:co.jp', '引越し業者 "法人契約" "問い合わせ" site:jp']
