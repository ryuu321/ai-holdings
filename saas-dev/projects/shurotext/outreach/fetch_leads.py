"""
shurotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['就労支援', 'ワーク', 'サポート', '福祉', 'センター', '工房', '事業所', '生活介護', '地域活動']

QUERIES = ['障害者就労支援B型 事業所 "お問い合わせ" site:co.jp -求人', '就労継続支援B型 "info@" -採用', '障害福祉サービス事業所 "メールでのお問い合わせ" -転職', '就労支援B型 連絡先 site:jp -募集', '障害者支援施設 "お問い合わせフォーム" site:co.jp', '地域活動支援センター "メールアドレス" -求人', '就労移行支援事業所 "連絡先" site:jp -採用', '福祉作業所 "お問い合わせ" site:co.jp -求人', 'B型事業所 "info@" -募集', '障害者就労支援 "お問い合わせ" site:jp -転職', '生活介護事業所 "メールアドレス" site:co.jp -求人', '多機能型事業所 "連絡先" site:jp -採用', '就労支援事業 "info@" -募集', '障害者福祉 "お問い合わせフォーム" site:co.jp -求人', 'B型施設 "メールアドレス" site:jp -転職']
