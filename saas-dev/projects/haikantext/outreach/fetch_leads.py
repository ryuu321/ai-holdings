"""
haikantext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['配管', '設備', '管工事', '空調', '衛生', '給排水', 'プラント', 'メンテナンス', '施工']

QUERIES = ['配管工事会社 "お問い合わせ" site:co.jp -求人 -採用', '設備工事会社 "info@" site:co.jp -求人 -採用', '管工事 施工会社 "メールアドレス" site:co.jp -転職', '空調設備工事 "お問い合わせフォーム" site:co.jp -求人', '給排水設備工事 "連絡先" site:co.jp -採用', '衛生設備工事 "メール" site:co.jp -転職', 'ボイラー設備 点検 "問い合わせ" site:co.jp -求人', 'プラント配管 メンテナンス "お問い合わせ" site:co.jp -採用', '工場設備 改修 "連絡先" site:co.jp -転職', 'ビル設備 管理 "メールアドレス" site:co.jp -求人', '消防設備 工事 "お問い合わせ" site:co.jp -採用', '熱源設備 施工 "info@" site:co.jp -転職', 'ダクト工事 専門 "連絡先" site:co.jp -求人', '給湯設備 修理 "お問い合わせフォーム" site:co.jp -採用', '冷暖房設備 設置 "メール" site:co.jp -転職']
