"""
sekkotsutext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['整骨院', '接骨院', '鍼灸院', '整体院', '治療院', 'リハビリ']

QUERIES = ['整骨院 採用情報 連絡先 site:co.jp -求人', '接骨院 問い合わせ メールアドレス site:jp -採用', '〇〇整骨院 公式サイト 連絡先 -転職', '鍼灸整骨院 経営者 ブログ 連絡先', 'グループ整骨院 事務局 連絡先', '整骨院 院長 メールアドレス', '接骨院 運営会社 お問い合わせ', '整骨院 業務提携 連絡先', '整骨院 採用担当 連絡先', '整骨院 事務長 連絡先', '整骨院 経営相談 連絡先', '整骨院 施設長 連絡先', '整骨院 開業支援 連絡先']
