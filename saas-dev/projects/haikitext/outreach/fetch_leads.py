"""
haikitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['環境', 'リサイクル', 'クリーン', '資源', '廃棄物', '処理', '収集運搬']

QUERIES = ['産業廃棄物処理 会社 お問い合わせ site:co.jp -求人', '産業廃棄物収集運搬 連絡先 site:jp -採用', '廃棄物処理業者 問い合わせフォーム site:co.jp -転職', '環境サービス 事業者 メールアドレス site:jp -募集', '産業廃棄物 中間処理 会社 連絡先 site:co.jp', 'リサイクル業者 法人 問い合わせ site:jp -個人', '廃棄物管理 コンサルティング 会社 連絡先 site:co.jp', '建設廃棄物 処理業者 問い合わせ site:jp -求人', '医療廃棄物 処理 会社 連絡先 site:co.jp', '食品廃棄物 リサイクル 業者 問い合わせ site:jp', '産業廃棄物 最終処分場 運営会社 連絡先 site:co.jp', '解体工事 廃棄物処理 会社 問い合わせ site:jp', '産業廃棄物処理業 協会 会員企業 連絡先 site:co.jp', '廃棄物処理計画書 作成代行 会社 問い合わせ site:jp', 'マニフェスト管理 システム 導入 会社 連絡先 site:co.jp']
