"""
kaikeishitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['税理士法人', '会計事務所', '公認会計士事務所', '監査法人', '税理士', '公認会計士']

QUERIES = ['会計事務所 "お問い合わせ" site:co.jp -求人', '税理士法人 "メールアドレス" site:jp -採用', '公認会計士事務所 "連絡先" site:or.jp -転職', '会計事務所 "info@" -採用', '税理士事務所 "お問い合わせフォーム" -求人', '会計事務所 "代表メール" site:co.jp', '税理士法人 "連絡先" "東京" -採用', '会計事務所 "無料相談" "メール" -求人', '税理士 "お問い合わせ" "大阪" -採用', '公認会計士 "連絡先" "福岡" -転職', '会計事務所 "法人向け" "お問い合わせ" -採用', '税理士法人 "顧問契約" "メール" -求人', '会計事務所 "サービス内容" "お問い合わせ" -採用', '税理士事務所 "アクセス" "メール" -求人', '会計事務所 "経営支援" "お問い合わせ" -採用']
