"""
shikatext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['歯科', 'クリニック', '医院', 'デンタル', 'オーラル', '歯医者']

QUERIES = ['歯科クリニック お問い合わせ site:co.jp -求人', '歯科医院 info@ site:jp -採用', '矯正歯科 クリニック メールアドレス site:or.jp', '小児歯科 医院 お問い合わせフォーム site:co.jp', 'インプラント 歯科 クリニック 連絡先 site:jp', '審美歯科 医院 メールでのお問い合わせ site:co.jp', '東京都 歯科クリニック 連絡先 site:jp', '大阪府 歯科医院 お問い合わせ site:or.jp', '口腔外科 クリニック メール site:co.jp', '歯周病専門医 歯科医院 お問い合わせ site:jp', '訪問歯科 クリニック 連絡先 site:co.jp', 'デンタルクリニック お問い合わせ site:jp -転職', 'ホワイトニング 歯科医院 メールアドレス site:co.jp', '予防歯科 クリニック 連絡先 site:jp', '一般歯科 医院 お問い合わせ site:or.jp']
