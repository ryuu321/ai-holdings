"""
shogyotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['司法書士', '法務事務所', '合同事務所', '登記', '商業']

QUERIES = ['司法書士事務所 商業登記 問い合わせ site:co.jp -求人', '司法書士法人 商業登記 連絡先 site:jp -採用', '司法書士 商業登記 相談 メール site:or.jp -転職', '商業登記 司法書士 事務所名簿 site:jp -ランキング', '法務事務所 商業登記 サービス案内 site:co.jp -比較', '司法書士 商業登記 顧問契約 site:jp -まとめ', '司法書士 商業登記 料金表 site:co.jp -ブログ', '司法書士 商業登記 専門 site:jp -記事', '司法書士 商業登記 補助者 募集 site:jp -求人', '司法書士 商業登記 業務内容 site:co.jp -セミナー', '司法書士 商業登記 会社設立 site:jp -講座', '司法書士 商業登記 役員変更 site:co.jp -イベント', '司法書士 商業登記 本店移転 site:jp -ニュース', '司法書士 商業登記 増資 site:co.jp -メディア', '司法書士 商業登記 組織再編 site:jp -コラム']
