"""
居宅介護支援事業所（ケアマネ）リードをBrave APIで収集
...
_COMPANY_KEYWORDS = ["居宅介護支援", "ケアプラン", "ケアマネ", "ケアマネジャー", "介護支援"]

QUERIES = [
    '居宅介護支援事業所 "お問い合わせ" site:co.jp -求人',
    'ケアプランセンター "メールでのお問い合わせ" -採用 -求人',
    '居宅介護支援 "info@" site:co.jp -ランキング',
    'ケアマネジャー "お問い合わせ" -一覧 -比較',
    '居宅介護支援事業所 "contact@" site:co.jp',
    'ケアマネ "メール" ケアプラン -求人 -ランキング',
    '居宅介護支援 東京 "お問い合わせ" site:co.jp -求人',
    'ケアプランセンター 大阪 "info@" -採用',
    '居宅介護支援事業所 名古屋 "メール" site:co.jp',
    'ケアマネ 神奈川 "お問い合わせ" -求人',
    '居宅介護支援 福岡 "contact@" site:co.jp',
    'ケアプランセンター 埼玉 "info@" -採用 -一覧',
    '居宅介護支援事業所 在宅 "お問い合わせ" site:co.jp',
    'ケアマネジャー 担当者会議 "メール" -求人',
    '居宅介護支援 モニタリング "お問い合わせ" -ランキング',
    'ケアプラン 独居 "info@" site:co.jp',
    '居宅介護支援事業所 "ご連絡" "メール" site:co.jp -まとめ',
    'ケアマネ 地域包括 "お問い合わせ" -一覧',
    '介護支援専門員 "info@" site:co.jp -求人',
    '居宅介護支援 認知症 "お問い合わせ" site:co.jp',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; CmTextBot/1.0)"})
