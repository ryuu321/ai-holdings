"""
senmontext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['専門学校', '学院', 'カレッジ', 'スクール', '大学校']

QUERIES = ['"専門学校" "お問い合わせ" site:ac.jp -求人 -採用', '"専門学校" "info@" site:ac.jp -採用 -募集', '"専門学校" "メールアドレス" site:ac.jp -求人 -転職', '"専門学校" "資料請求" "メール" site:ac.jp', '"医療専門学校" "お問い合わせ" site:ac.jp', '"看護専門学校" "info@" site:ac.jp', '"IT専門学校" "お問い合わせ" site:ac.jp', '"デザイン専門学校" "メール" site:ac.jp', '"調理専門学校" "お問い合わせ" site:ac.jp', '"美容専門学校" "info@" site:ac.jp', '"専門学校" "法人向け" "お問い合わせ" site:ac.jp', '"専門学校" "教育連携" "お問い合わせ" site:ac.jp', '"専門学校" "学校法人" "連絡先" site:ac.jp', '"専門学校" "事務室" "お問い合わせ" site:ac.jp', '"専門学校" "キャリアセンター" "連絡先" site:ac.jp']
