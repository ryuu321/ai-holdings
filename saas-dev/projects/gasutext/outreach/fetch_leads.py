"""
gasutext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['管工事', '設備', '工業', '水道', 'ガス', '給排水', 'プラント', 'エンジニアリング', 'メンテナンス', '配管']

QUERIES = ['ガス工事 会社 "お問い合わせ" site:co.jp -求人 -採用', '水道工事 会社 "info@" site:co.jp -求人 -採用', '給排水設備 工事 "メールでのお問い合わせ" site:co.jp -転職 -採用', '管工事 会社 "連絡先" site:co.jp -求人 -採用', '設備工事 業者 "お問い合わせフォーム" site:co.jp -求人 -採用', 'ガス配管 工事 "メールアドレス" site:co.jp -求人 -採用', '水道管 メンテナンス 会社 "お問い合わせ" site:co.jp -求人 -採用', '給湯器 交換 工事 "お問い合わせ" site:co.jp -求人 -採用', '排水設備 点検 業者 "お問い合わせ" site:co.jp -求人 -採用', 'ガス設備 保守 会社 "連絡先" site:co.jp -求人 -採用', '水道メーター 交換 業者 "info@" site:co.jp -求人 -採用', '空調設備 工事 会社 "お問い合わせ" site:co.jp -求人 -採用', 'リフォーム 会社 "ガス工事" "お問い合わせ" site:co.jp -求人 -採用', 'マンション 給排水管 工事 "お問い合わせ" site:co.jp -求人 -採用', 'ビル設備 管理 "ガス" "水道" "お問い合わせ" site:co.jp -求人 -採用']
