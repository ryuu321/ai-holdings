"""
extext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['ガーデン', '造園', '庭', '外構', 'エクステリア', 'ランドスケープ', 'グリーン', '土木', '建設', '環境']

QUERIES = ['"エクステリア 工事" "お問い合わせ" site:co.jp -求人', '"外構 工事" "見積もり" site:jp -採用', '"造園 設計" "メールアドレス" site:com -転職', '"庭 リフォーム" "連絡先" site:co.jp -ブログ', '"ガーデン デザイン" "資料請求" site:jp -比較', '"エクステリア 施工" "お問い合わせフォーム" site:com -ランキング', '"外構 専門" "お問い合わせ" site:co.jp -wiki', '"ランドスケープ デザイン" "メール" site:jp -まとめ', '"庭づくり" "ご相談" site:com -選び方', '"フェンス 工事" "お問い合わせ" site:co.jp -一覧', '"ウッドデッキ 施工" "info@" site:jp -DIY', '"駐車場 工事" "メールでのお問い合わせ" site:com -個人', '"エクステリア 会社" "お問い合わせ" site:co.jp -代理店', '"外構 業者" "連絡先" site:jp -フランチャイズ', '"造園 業者" "資料請求" site:com -求人']
