"""
extext アウトリーチ送信スクリプト（Gmail SMTP・30件/日）
"""
import argparse
import csv
import os
...
_COMPANY_REQUIRED = ['ガーデン', '造園', '庭', '外構', 'エクステリア', 'ランドスケープ', 'グリーン', '土木', '建設', '環境']
_BLOG_SIGNALS = ['コツ', '選び方', 'ランキング', '比較', 'まとめ', '一覧', '営業リスト', '費用', '相場', 'メリット', 'デメリット']
