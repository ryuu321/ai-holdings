"""
iryokikitext アウトリーチ送信スクリプト（Gmail SMTP・30件/日）
"""
import argparse
import csv
import os
...
_COMPANY_REQUIRED = ['医療機器', 'メディカル', 'ヘルスケア', '病院', 'クリニック', '医科', '歯科', '福祉', '介護', '薬局', '検査']
_BLOG_SIGNALS = ['コツ', '選び方', 'ランキング', '比較', 'まとめ', '一覧', '営業リスト', '導入事例', '成功事例', '課題解決', '業務効率化']
