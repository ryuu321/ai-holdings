"""
iryokikitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['医療機器', 'メディカル', 'ヘルスケア', '病院', 'クリニック', '医科', '歯科', '福祉', '介護', '薬局', '検査']

QUERIES = ['医療機器販売業者 "お問い合わせ" site:co.jp -求人 -採用', '医療機器メーカー "info@" site:co.jp -求人 -採用', '医療機器商社 "メールでのお問い合わせ" -転職 -募集', '病院 医療機器 導入 相談 "連絡先" site:jp', 'クリニック 医療機器 提案 "お問い合わせ" site:jp', '医療法人 医療機器 選定 "ご担当者様" site:or.jp', '介護施設 医療機器 導入 "お問い合わせ" site:jp', '健診センター 医療機器 更新 "連絡先" site:jp', '医療機器 営業代行 "お問い合わせ" site:co.jp', '医療機器 メンテナンス 業者 "連絡先" site:co.jp', '医療機器 販売会社 "お問い合わせフォーム" site:co.jp', '医療機器 リース 会社 "info@" site:co.jp', '医療機器 導入支援 "お問い合わせ" site:jp', '医療機器 卸売 "連絡先" site:co.jp', '医療機器 代理店 "お問い合わせ" site:co.jp']
