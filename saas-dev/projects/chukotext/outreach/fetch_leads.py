"""
chukotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['オート', 'カー', 'モータース', '販売', '買取', '中古車', 'ガレージ', '自動車']

QUERIES = ['中古車販売店 会社概要 連絡先 site:co.jp', '中古車買取専門店 お問い合わせ メール site:jp', '自動車販売店 経営者 連絡先 site:co.jp', '中古車ディーラー 法人向け 問い合わせ site:jp', '中古車販売 業務効率化 ツール 導入事例 site:co.jp', '中古車査定システム 連絡先 site:jp', '自動車買取フランチャイズ 問い合わせ先 site:co.jp', '中古車販売 経営課題 解決策 site:jp', '中古車販売 営業支援 ツール 導入 site:co.jp', '中古車流通 業界動向 連絡先 site:jp', '中古車販売 担当者向け 問い合わせ site:co.jp', '自動車販売 業務改善 連絡先 site:jp', '中古車販売店 採用情報 ではなく 問い合わせ site:co.jp', 'カーディーラー 経営企画 連絡先 site:jp', '中古車販売 顧客管理システム 導入検討 site:co.jp']
