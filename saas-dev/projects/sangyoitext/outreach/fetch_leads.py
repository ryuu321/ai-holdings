"""
sangyoitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['産業医', '健康経営', '安全衛生', '保健師', '労働衛生', '健康管理室', '衛生委員会']

QUERIES = ['産業医 業務委託 問い合わせ site:co.jp -求人', '健康経営 相談 連絡先 site:jp -採用', '安全衛生委員会 事務局 連絡先 site:co.jp', '産業保健サービス 導入 問い合わせ site:co.jp', 'ストレスチェック 実施 相談 info@ site:jp', '健康管理室 担当者 連絡先 site:co.jp', '衛生管理者 業務 効率化 問い合わせ site:jp', '産業医 契約 問い合わせ site:co.jp -転職', '健康経営優良法人 申請 相談 info@ site:jp', '労働衛生コンサルタント 連絡先 site:co.jp', 'メンタルヘルス対策 導入 問い合わせ site:jp', '職場環境改善 相談 連絡先 site:co.jp', '健康診断 事後措置 相談 info@ site:jp', '過重労働対策 問い合わせ site:jp', '産業保健活動 支援 連絡先 site:co.jp']
