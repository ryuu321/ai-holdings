...
SITE_SKIP = ["wikipedia", "google", "yahoo", "twitter", "facebook", "instagram",
             ...
             "kakaku.com", "houzz.jp", "suumo.jp", "homepro.jp", "jutaku-map"]

_COMPANY_KEYWORDS = ["塗装", "防水", "外壁", "塗工", "施工", "工業", "工務店"]

QUERIES = [
    '塗装会社 "お問い合わせ" site:co.jp -求人',
    '防水工事 "メールでのお問い合わせ" -採用',
    '外壁塗装 "info@" site:co.jp',
    '塗装業 "お問い合わせ" -ランキング -一覧',
    '防水工事会社 "メール" -求人 site:co.jp',
    '塗装工事 "contact" -採用',
    '外壁・屋根塗装 "お問い合わせ" site:co.jp',
    '塗装 防水 "メールアドレス" -比較',
    '塗装業者 東京 "info@" -求人',
    '防水工事 大阪 "お問い合わせ" site:co.jp',
    '外壁塗装 名古屋 "メール" -採用',
    '塗装会社 福岡 "お問い合わせ"',
    '防水工事 神奈川 "contact@"',
    '塗装 埼玉 "info@" site:co.jp',
    '屋根塗装 外壁塗装 "お問い合わせ" -一覧',
    '外壁防水 "メール" site:co.jp',
    '塗装工事 住宅 "お問い合わせ" site:co.jp',
    '防水工事業者 "info@" -求人',
    '塗装 "工事部" "お問い合わせ"',
    '外壁塗装 "施工実績" "お問い合わせ" site:co.jp',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; TosTextBot/1.0)"})
