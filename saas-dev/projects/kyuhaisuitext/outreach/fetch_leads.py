"""
kyuhaisuitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['給排水', '管工事', '衛生設備', 'ビル管理', '貯水槽', '排水管', 'ポンプ', '水処理', '設備保全', 'メンテナンス']

QUERIES = ['給排水設備メンテナンス業者 "お問い合わせ" site:co.jp -求人', '貯水槽清掃業者 "info@" -採用', '排水管高圧洗浄 "メールアドレス" -転職', 'ビル管理 衛生設備 "連絡先" -募集', '給水設備点検 会社 "お問い合わせフォーム" site:jp', '給排水衛生設備工事 "contact" -求人', 'ポンプ点検 修理 業者 "メール" -採用', '水質検査 報告書 作成 業者 "お問い合わせ" site:co.jp', 'マンション 給排水管 更新工事 "連絡先" -求人', '工場 排水処理 メンテナンス "info@" -採用', '病院 衛生設備 管理 "お問い合わせ" site:jp', '給排水設備 緊急対応 "メール" -求人', '管工事会社 "お問い合わせ" site:co.jp -採用', 'ビル設備管理 報告書 作成 "連絡先"', '給排水設備 劣化診断 "メールアドレス" -転職']
