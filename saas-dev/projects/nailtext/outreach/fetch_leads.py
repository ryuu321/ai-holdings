"""
nailtext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['ネイル', 'Nail', 'サロン', 'ジェル', 'スカルプ', 'フットケア', 'ハンドケア']

QUERIES = ['ネイルサロン "お問い合わせ" site:co.jp -求人', 'ネイルサロン "info@" -採用 site:jp', 'ネイルサロン "メールでのお問い合わせ" -転職 site:com', 'ネイルサロン "法人様向け" "連絡先" site:jp', 'ネイルサロン "取材" "お問い合わせ" site:co.jp', 'ネイルサロン "提携" "担当者" site:jp', 'ネイルサロン "オーナー" "連絡先" site:com', 'ネイルサロン "マネージャー" "メール" site:jp', 'ネイルサロン "サロン経営" "お問い合わせ" site:co.jp', 'ネイルサロン "業務提携" "メールアドレス" site:jp', 'ネイルサロン "広報" "連絡先" site:com', 'ネイルサロン "代表" "お問い合わせ" site:jp', 'ネイルサロン "パートナー募集" "メール" site:co.jp', 'ネイルサロン "店舗運営" "お問い合わせ" site:jp', 'ネイルサロン "経営者" "連絡先" site:com']
