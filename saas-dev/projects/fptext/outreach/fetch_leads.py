"""
fptext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['FP', 'ファイナンシャルプランナー', 'ライフプラン', '資産運用', '保険', 'コンサルティング']

QUERIES = ['ファイナンシャルプランナー 事務所 お問い合わせ site:co.jp -求人', 'FP事務所 連絡先 site:jp -採用', 'ライフプラン相談 会社 問い合わせメール', '資産運用アドバイザー 企業 連絡先', '保険見直し コンサルティング 事務所 メールアドレス', '独立系FP 連絡先 site:com', 'ファイナンシャルプランニング法人 お問い合わせフォーム', 'FP法人 採用情報以外 連絡先', 'ライフプランナー 会社概要 メール', '資産形成アドバイス 会社 連絡先', '個人向けFPサービス 問い合わせ先', 'FPコンサルティング 会社 お問い合わせ', 'ファイナンシャルアドバイザー 連絡先 site:jp', 'FPオフィス 問い合わせ先 メール', 'ライフプラン設計 会社 連絡先']
