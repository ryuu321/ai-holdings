"""
rifotext アウトリーチ送信スクリプト（Gmail SMTP・30件/日）
"""
import argparse
import csv
import os
...
_COMPANY_REQUIRED = ['リフォーム', '工務店', '建設', '住宅', '増改築', '塗装', '水回り', '内装', '外装', 'リノベーション']
_BLOG_SIGNALS = ['コツ', '選び方', 'ランキング', '比較', 'まとめ', '一覧', '営業リスト', '成功事例', 'ノウハウ', 'メリット']
