"""
rifotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['リフォーム', '工務店', '建設', '住宅', '増改築', '塗装', '水回り', '内装', '外装', 'リノベーション']

QUERIES = ['リフォーム会社 "お問い合わせ" site:co.jp -求人 -採用', 'リフォーム "info@" site:jp -転職 -ブログ', '住宅リフォーム "メールアドレス" site:co.jp -募集', '外壁塗装 "お問い合わせフォーム" site:jp -価格', '内装工事 "連絡先" site:com -見積もり', '水回りリフォーム "お問い合わせ" site:co.jp -キャンペーン', 'マンションリノベーション "メール" site:jp -事例', '店舗改装 "お問い合わせ" site:co.jp -フランチャイズ', '増改築 "連絡先" site:jp -ブログ', 'リフォーム業者 "お問い合わせ" site:co.jp -費用', '工務店 "info@" site:jp -採用情報', '建設会社 "お問い合わせ" site:co.jp -IR', 'リノベーション会社 "メールアドレス" site:jp -求人', '住宅設備工事 "お問い合わせ" site:co.jp -製品', '地域密着型リフォーム "連絡先" site:jp -口コミ']
