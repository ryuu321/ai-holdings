"""
gakudotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['学童', '児童クラブ', '放課後児童クラブ', 'キッズクラブ', 'アフタースクール', '育成クラブ', '児童館']

QUERIES = ['学童保育 "お問い合わせ" site:co.jp -求人 -採用', '放課後児童クラブ "連絡先" site:jp -募集 -転職', '民間学童 "メールアドレス" site:co.jp -アルバイト', 'アフタースクール "お問い合わせ" site:jp -採用情報', '学童クラブ "info@" site:co.jp -リクルート', '放課後キッズクラブ "お問い合わせフォーム" site:jp -求人情報', '児童育成クラブ "連絡先" site:co.jp -採用', '学童保育施設 "メール" site:jp -募集', '学童保育運営会社 "お問い合わせ" site:co.jp -求人', '学童保育サービス "連絡先" site:jp -採用', '学童保育法人 "お問い合わせ" site:co.jp -転職', '放課後児童支援 "メール" site:jp -求人', '学童保育事業 "連絡先" site:co.jp -募集', '学童保育所 "お問い合わせ" site:jp -採用', '児童クラブ運営 "メールアドレス" site:co.jp -求人']
