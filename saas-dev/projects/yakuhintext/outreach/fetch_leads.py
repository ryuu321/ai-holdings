"""
yakuhintext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['製薬', '化学', '薬品', '工業', '素材', 'ファイン', 'バイオ', '研究所', '工場', '製造']

QUERIES = ['薬品製造会社 問い合わせ先 site:co.jp -求人', '化学品メーカー 連絡先 site:jp -採用', '医薬品原料 製造業者 メールアドレス site:co.jp', 'ファインケミカル 企業 お問い合わせ site:jp', '工業用化学品 メーカー 連絡先 site:co.jp', 'バイオケミカル 製造 担当者 site:jp', '医薬中間体 製造 営業部 site:co.jp', '試薬 メーカー 問い合わせフォーム site:jp', '高分子材料 製造会社 連絡先 site:co.jp', '香料 メーカー 営業担当 site:jp', '塗料 製造業者 お問い合わせ site:co.jp', '接着剤 メーカー 連絡先 site:jp', '界面活性剤 製造会社 営業部 site:co.jp', '樹脂 メーカー 問い合わせ先 site:jp', '機能性材料 製造業者 連絡先 site:co.jp']
