"""
constext アウトリーチ送信スクリプト（Gmail SMTP・30件/日）
"""
import argparse
import csv
import os
...
_COMPANY_REQUIRED = ['コンサルティング', 'ソリューション', 'アドバイザリー', 'ストラテジー', 'マネジメント', 'パートナーズ', 'ファーム', '経営', 'IT', '戦略', '人事', 'M&A', 'DX', '業務改善']
_BLOG_SIGNALS = ['コツ', '選び方', 'ランキング', '比較', 'まとめ', '一覧', '営業リスト']
