"""
dobokutext アウトリーチ送信スクリプト（Gmail SMTP・30件/日）
"""
import argparse
import csv
import os
...
_COMPANY_REQUIRED = ['建設', '土木', '舗装', '工業', '道路', '造成', '管', '興業', '開発', '建設コンサルタント']
_BLOG_SIGNALS = ['書類作成', '効率化', 'DX', '現場管理', 'コスト削減', '生産性向上', '業務改善', 'テンプレート', 'AI活用']
