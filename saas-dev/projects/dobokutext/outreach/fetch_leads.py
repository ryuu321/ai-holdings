"""
dobokutext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['建設', '土木', '舗装', '工業', '道路', '造成', '管', '興業', '開発', '建設コンサルタント']

QUERIES = ['土木工事業 "お問い合わせ" site:co.jp -求人 -採用', '舗装工事業 "info@" site:co.jp -求人 -採用', '建設会社 "メールアドレス" "土木" site:co.jp -転職 -リクルート', '道路工事 "連絡先" site:co.jp -求人 -採用', '造成工事 "お問い合わせフォーム" site:co.jp -求人', '河川工事 "事業内容" "連絡先" site:co.jp -採用', '上下水道工事 "お問い合わせ" site:co.jp -求人', '外構工事 "メール" site:co.jp -採用', '解体工事 "お問い合わせ" site:co.jp -求人 -採用', '港湾工事 "contact" site:co.jp -求人', '建設コンサルタント "お問い合わせ" site:co.jp -求人 -採用', '建設業 "施工実績" "メール" site:co.jp -転職', '土木工事 "見積もり" "お問い合わせ" site:co.jp -求人', '舗装工事 "会社概要" "連絡先" site:co.jp -採用', '建設工事 "お問い合わせ" "担当者" site:co.jp -求人 -採用']
