"""
sokotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['倉庫', '物流', '運送', '配送', 'ロジスティクス', '運輸', '港湾', '通運', '保管', '3PL', '冷凍', '危険物']

QUERIES = ['倉庫管理 会社 お問い合わせ site:co.jp -求人 -採用', '物流センター 連絡先 site:co.jp -転職 -募集', '運送会社 info@ site:co.jp -求人 -採用', '配送サービス メールアドレス site:co.jp -転職 -募集', 'ロジスティクス お問い合わせフォーム site:co.jp -求人 -採用', '倉庫業 代表メール site:co.jp -転職 -募集', '港湾運送 問い合わせ先 site:co.jp -求人 -採用', '通運事業 連絡先 site:co.jp -転職 -募集', '危険物倉庫 お問い合わせ site:co.jp -求人 -採用', '冷凍倉庫 info@ site:co.jp -転職 -募集', 'EC物流 お問い合わせ site:co.jp -求人 -採用', '3PL 連絡先 site:co.jp -転職 -募集', '倉庫業務改善 お問い合わせ site:co.jp -求人 -採用', '物流コンサルティング info@ site:co.jp -転職 -募集', '倉庫安全管理 お問い合わせ site:co.jp -求人 -採用']
