"""
sonpohokentext アウトリーチ送信スクリプト（Gmail SMTP・30件/日）
"""
import argparse
import csv
import os
...
_COMPANY_REQUIRED = ['損保', '保険', '代理店', 'リスクマネジメント', 'コンサルティング', '法人保険', '事業保険']
_BLOG_SIGNALS = ['業務改善', '効率化', '書類作成', '提案書 書き方', '事故対応', 'DX', '生産性向上', 'バックオフィス']
