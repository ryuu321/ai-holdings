"""
yanetext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['板金', '屋根', '瓦', '防水', '外装', 'リフォーム', '工業', '工務店', '建設', '技研', '技工', '建装', '住設', 'ルーフ']

QUERIES = ['建築板金 屋根工事 会社 お問い合わせ site:co.jp -求人 -採用', '屋根修理 専門業者 連絡先 site:co.jp -募集 -ブログ', '板金工事 施工会社 メールアドレス site:co.jp -転職 -採用', '屋根リフォーム 見積もり 相談 site:co.jp -ブログ -事例', '外壁塗装 屋根工事 問い合わせフォーム site:co.jp -ブログ -採用', '地域名 屋根工事 業者 連絡先 site:co.jp -求人 -ブログ', '屋根診断 会社 連絡先 site:co.jp -採用 -ブログ', '雨漏り修理 専門業者 お問い合わせ site:co.jp -求人 -ブログ', '建築板金業 企業情報 連絡先 site:co.jp -採用 -ブログ', '屋根工事 会社概要 メール site:co.jp -求人 -ブログ', '屋根・外壁リフォーム 業者 問い合わせ site:co.jp -ブログ -事例', '板金工事業 会社 連絡先 site:co.jp -求人 -ブログ', '屋根工事 施工事例 連絡先 site:co.jp -求人 -ブログ', '屋根リフォーム 専門会社 お問い合わせ site:co.jp -ブログ -事例', '建築板金 屋根工事 会社名 連絡先 site:co.jp -求人 -ブログ']
