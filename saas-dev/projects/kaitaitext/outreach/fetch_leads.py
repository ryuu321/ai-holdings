"""
kaitaitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['解体', '建設', '工業', '興業', '環境', 'リサイクル']

QUERIES = ['解体工事業者 問い合わせ site:co.jp -求人 -採用', '解体工事会社 連絡先 site:jp -転職 -募集', '解体工事 見積もり 依頼 メールアドレス', '産業廃棄物処理 業者 問い合わせ先', '建設業 解体工事 会社概要 メール', '木造解体 専門業者 問い合わせ', 'RC解体 専門業者 問い合わせ', 'アスベスト除去 専門業者 問い合わせ', '解体工事 安全管理 担当者 メール', '解体工事 現場管理 連絡先', '解体工事 協力会社 募集 問い合わせ', '解体工事 施工事例 連絡先', '解体工事 相談窓口 メールアドレス', '解体工事 サービス内容 問い合わせ']
