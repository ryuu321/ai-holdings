"""
gogakutext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['英会話', '語学', '外国語', 'ランゲージ', 'スクール', '教室', 'アカデミー']

QUERIES = ['英会話スクール 運営会社 "お問い合わせ" site:co.jp -求人 -採用', '語学教室 経営 "連絡先" site:co.jp -転職 -募集', '子供英会話教室 "メールアドレス" site:co.jp -求人', 'ビジネス英会話スクール "お問い合わせ" site:jp -採用', 'TOEIC対策スクール "info@" site:co.jp -求人', 'オンライン英会話 運営 "お問い合わせ" site:jp -募集', '外国語教室 "連絡先" site:co.jp -求人', '語学学校 "メールでのお問い合わせ" site:co.jp -採用', 'マンツーマン英会話 "お問い合わせ" site:jp -転職', '英会話スクール 法人 "連絡先" site:co.jp -求人', '語学教育機関 "info@" site:jp -募集', '留学準備スクール "お問い合わせ" site:co.jp -採用', '英会話 教室長 "連絡先" site:jp -求人', '語学学習サービス "お問い合わせ" site:co.jp -転職', '英会話スクール 事務局 "メール" site:jp -募集']
