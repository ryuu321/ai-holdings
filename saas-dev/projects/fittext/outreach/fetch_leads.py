"""
fittext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['フィットネス', 'ジム', 'スタジオ', 'クラブ', 'パーソナル', 'ヨガ', '健康', '運動', 'ウェルネス', 'スポーツ']

QUERIES = ['フィットネスジム 運営会社 お問い合わせ site:co.jp -求人', 'パーソナルトレーニングジム 経営者 info@ -採用', 'ヨガスタジオ 法人向け 問い合わせ site:jp -転職', 'スポーツクラブ 運営本部 連絡先 -採用', '健康増進施設 経営 お問い合わせ -求人', 'フィットネスチェーン 提携 問い合わせ', '地域密着型ジム 担当者 メールアドレス', '24時間ジム フランチャイズ 連絡先', 'ホットヨガスタジオ 事業提携 問い合わせ', 'スイミングスクール 運営会社 連絡先', 'フィットネスクラブ 経営者 メールアドレス', 'ジム経営者 業務提携 問い合わせ', 'ウェルネス施設 運営責任者 連絡先', 'リハビリ型デイサービス 施設長 問い合わせ', 'フィットネス業界 企業情報 問い合わせ先']
