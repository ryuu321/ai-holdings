"""
hokentext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['保険', '代理店', '総合', 'リスク', 'コンサルティング', 'ファイナンシャルプランニング']

QUERIES = ['保険代理店 "お問い合わせ" site:co.jp -求人', '保険代理店 "info@" site:co.jp -採用', '保険代理店 "メールでのお問い合わせ" site:co.jp -転職', '保険代理店 "連絡先" site:co.jp -採用 -求人', '保険代理店 "お問い合わせフォーム" site:co.jp -採用 -求人', '保険代理店 "contact" site:co.jp -採用 -求人', '保険代理店 "会社概要" "メール" site:co.jp', '保険代理店 "アクセス" "お問い合わせ" site:co.jp', '保険代理店 "法人のお客様" "お問い合わせ" site:co.jp', '保険代理店 "個人のお客様" "お問い合わせ" site:co.jp', '保険代理店 "サービス内容" "連絡先" site:co.jp', '保険代理店 "代表者" "お問い合わせ" site:co.jp', '保険代理店 "パートナー募集" "お問い合わせ" site:co.jp', '保険代理店 "事業所一覧" "メール" site:co.jp', '保険代理店 "保険相談" "お問い合わせ" site:co.jp']
