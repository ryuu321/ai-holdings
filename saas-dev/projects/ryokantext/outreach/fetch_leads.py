"""
ryokantext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['旅館', 'ホテル', '温泉', '宿', 'リゾート', '観光']

QUERIES = ['"旅館" "お問い合わせ" site:co.jp -求人 -採用 -転職', '"ホテル" "info@" site:co.jp -求人 -採用 -転職', '"温泉宿" "連絡先" site:co.jp -求人 -採用 -転職', '"宿泊施設" "メールアドレス" site:co.jp -求人 -採用 -転職', '"観光ホテル" "担当者" site:co.jp -求人 -採用 -転職', '"旅館業" "業務効率化" "問い合わせ" site:co.jp', '"ホテル" "サービス改善" "連絡先" site:co.jp', '"温泉旅館" "運営" "問い合わせ" site:co.jp', '"シティホテル" "営業部" "メール" site:co.jp', '"リゾートホテル" "経営" "連絡先" site:co.jp', '"旅館" "広報" "メール" site:co.jp -求人 -採用', '"ホテル" "支配人" "連絡先" site:co.jp -求人 -採用', '"宿泊プラン" "作成" "効率化" "問い合わせ" site:co.jp', '"クレーム対応" "マニュアル" "作成" "相談" site:co.jp', '"館内規定" "テンプレート" "作成" "問い合わせ" site:co.jp']
