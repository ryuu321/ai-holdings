"""
drugtext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['薬局', 'ドラッグ', 'ファーマシー', '調剤', 'ヘルスケア', 'メディカル', 'クスリ', '薬']

QUERIES = ['ドラッグストア "お問い合わせ" site:co.jp -求人', 'ドラッグストア "info@" site:co.jp -採用', 'ドラッグストア "メールでのお問い合わせ" site:co.jp -転職', '薬局チェーン "法人のお客様" site:co.jp', '調剤薬局 "お問い合わせフォーム" site:jp', 'ドラッグストア "代表メールアドレス" site:co.jp', 'ヘルスケア "提携企業募集" site:co.jp', '地域密着型薬局 "お問い合わせ" site:jp -採用情報', 'ドラッグストア "新規取引" site:co.jp', '薬局 "経営者向け" site:jp', 'ドラッグストア "店舗開発" site:co.jp', '薬局 "業務改善" site:jp -ブログ', 'ドラッグストア "パートナー募集" site:co.jp', '医療法人 "お問い合わせ" site:jp -求人', 'ファーマシー "法人窓口" site:co.jp']
