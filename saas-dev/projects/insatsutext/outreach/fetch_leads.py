"""
insatsutext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['印刷', '製本', '出版', 'プリント', '加工', 'デザイン', 'グラフィック']

QUERIES = ['印刷会社 問い合わせ site:co.jp -求人 -採用', '印刷会社 連絡先 site:jp -転職 -募集', '印刷会社 メールアドレス site:com -job -recruit', '印刷 会社概要 連絡先 site:co.jp', '製本会社 お問い合わせ site:jp', 'デザイン印刷 問い合わせ site:co.jp', '商業印刷 連絡先 site:jp', 'オフセット印刷 問い合わせ site:co.jp', 'デジタル印刷 連絡先 site:jp', 'パッケージ印刷 問い合わせ site:co.jp', '特殊印刷 連絡先 site:jp', '印刷工場 問い合わせ site:co.jp', '印刷サービス 連絡先 site:jp', '印刷ソリューション 問い合わせ site:co.jp', '印刷会社 業務効率化 課題 site:co.jp']
