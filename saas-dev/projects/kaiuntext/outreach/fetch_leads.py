"""
kaiuntext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['海運', '港湾', '運送', '物流', '船舶', '汽船', '回漕', '船会社', 'マリン', '通船', '曳船']

QUERIES = ['"海運会社" "お問い合わせ" site:co.jp -求人 -採用', '"港湾運送" "連絡先" site:co.jp -転職 -募集', '"船舶管理" "メールアドレス" site:co.jp -求人', '"内航海運" "問い合わせ" site:jp -採用', '"外航海運" "info@" site:jp -転職', '"海運業" "連絡先" site:co.jp -求人', '"港湾物流" "お問い合わせ" site:co.jp -採用', '"船会社" "メール" site:jp -募集', '"海事コンサルティング" "連絡先" site:co.jp -求人', '"港湾施設管理" "お問い合わせ" site:jp -転職', '"海上運送" "info@" site:co.jp -採用', '"船舶代理店" "連絡先" site:jp -求人', '"海運倉庫" "お問い合わせ" site:co.jp -募集', '"港湾作業" "メールアドレス" site:jp -転職', '"海運事務" "連絡先" site:co.jp -求人']
