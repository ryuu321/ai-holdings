"""
kyoshujotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['自動車教習所', 'ドライビングスクール', '運転免許', '自動車学校', '教習所']

QUERIES = ['自動車教習所 "お問い合わせ" site:co.jp -求人', 'ドライビングスクール "連絡先" site:jp -採用', '運転免許センター "メールアドレス" site:co.jp -転職', '教習所 事務 "連絡先" site:jp -募集', '自動車学校 "お問い合わせ" site:co.jp -リクルート', '教習所 業務効率化 導入事例 site:jp', '自動車教習所 経営者 "連絡先" site:co.jp', '運転免許 教習所 管理システム site:jp', 'ドライビングスクール 担当者 "連絡先" site:co.jp', '教習所 事務長 メール site:jp', '自動車学校 運営会社 "問い合わせ" site:co.jp', '教習所 業務改善 相談 site:jp', '運転免許 教習所 事務連絡 site:co.jp', 'ドライビングスクール 経営企画 "連絡先" site:jp', '教習所 連絡先一覧 site:co.jp']
