"""
hashitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['橋梁', '鋼構造', '土木', '建設', '工業', 'エンジニアリング', '製作所', '架設', '補修']

QUERIES = ['橋梁工事 会社 お問い合わせ site:co.jp -求人', '鋼構造物 建設 連絡先 site:co.jp -採用', '土木工事 橋梁 問い合わせ site:co.jp -転職', '建設業 橋梁 施工管理 連絡先 site:co.jp -求人', '鋼構造物 製作 会社 問い合わせ site:co.jp -採用', '橋梁補修 工事 会社 お問い合わせ site:co.jp -求人', '建設コンサルタント 橋梁部門 連絡先 site:co.jp -採用', '橋梁架設 会社 お問い合わせ site:co.jp -転職', '鋼構造物 設計 施工 問い合わせ site:co.jp -求人', '特殊橋梁 工事 会社 連絡先 site:co.jp -採用', '建設業 橋梁 施工実績 問い合わせ site:co.jp -転職', '鋼構造物 メンテナンス 会社 お問い合わせ site:co.jp -求人', '橋梁点検 会社 連絡先 site:co.jp -採用', '建設業 橋梁 技術 問い合わせ site:co.jp -転職', '鋼構造物 溶接 会社 お問い合わせ site:co.jp -求人']
