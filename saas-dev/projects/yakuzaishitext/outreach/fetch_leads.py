"""
yakuzaishitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['病院', '医療センター', '総合病院', '大学病院', '医療法人', '薬剤部', '薬剤科']

QUERIES = ['医療機関 薬剤科 お問い合わせ', '総合病院 薬剤部 メールアドレス', '大学病院 薬剤部 事務室 連絡先', '地域医療連携室 薬剤師 連絡先', '病院 薬剤師 採用情報 連絡先', '医療法人 薬剤部 問い合わせ', '病院 経営企画室 薬剤部 連携', '病院 事務部 薬剤科 連絡先', '病院 医事課 薬剤部 連絡先', '病院 医療安全管理室 薬剤部', '病院 経営戦略 薬剤師', '病院 業務改善 薬剤部', '病院 薬剤師 課題解決']
