...
_COMPANY_KEYWORDS = ["放課後等デイサービス", "放デイ", "児童発達支援", "療育", "デイサービス"]

QUERIES = [
    '放課後等デイサービス "お問い合わせ" site:co.jp -求人',
    '放課後等デイサービス "メールでのお問い合わせ" -採用',
    '児童発達支援 放課後等デイサービス "info@" site:co.jp',
    '放課後等デイサービス 個別支援計画 "お問い合わせ" -ランキング',
    '放デイ "メール" -求人 site:co.jp',
    '放課後等デイサービス 療育 "お問い合わせ" site:co.jp',
    '放課後等デイサービス "contact" -採用',
    '療育 放課後 "メールアドレス" -求人',
    '放課後等デイサービス 東京 "info@" -求人',
    '放課後等デイサービス 大阪 "お問い合わせ" site:co.jp',
    '放課後等デイサービス 名古屋 "メール" -採用',
    '放課後等デイサービス 福岡 "お問い合わせ" site:co.jp',
    '放課後等デイサービス 神奈川 "contact@"',
    '放課後等デイサービス 埼玉 "info@"',
    '児童発達支援センター "お問い合わせ" site:co.jp',
    '放課後等デイサービス 発達障害 "メール" -ランキング',
    '放課後等デイサービス ASD ADHD "お問い合わせ"',
    '放課後等デイサービス 送迎 "info@"',
    '放課後等デイサービス 北海道 "お問い合わせ"',
    '放課後等デイサービス 兵庫 "info@" site:co.jp',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; AfterTextBot/1.0)"})
