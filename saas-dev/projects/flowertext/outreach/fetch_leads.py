"""
flowertext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['法人装花', 'オフィス装花', 'イベント装飾', '店舗装花', '定期装花', 'ホテル装花', '商業施設装花', 'ウェディング装花', '空間デザイン', 'フラワーディスプレイ']

QUERIES = ['法人装花 会社 お問い合わせ site:co.jp -求人', 'オフィス装花 業者 メールアドレス site:jp -採用', 'イベント装飾 会社 contact site:com -転職', '店舗装花 サービス お問い合わせフォーム site:co.jp', '定期装花 専門 info@ site:jp', 'ホテル装花 業者 お問い合わせ site:com', '商業施設 装花 会社 contact us site:co.jp', 'ウェディング装花 法人 問い合わせ site:jp -ブライダル', '展示会 装飾 会社 お問い合わせ site:com -出展', '空間デザイン 花 企業 contact site:co.jp', 'フラワーディスプレイ 法人 問い合わせ site:jp', '生花装飾 サービス メール site:com', 'グリーンレンタル 法人 お問い合わせ site:co.jp -個人', '観葉植物 レンタル 会社 info@ site:jp -個人', 'フラワーアレンジメント 法人向け お問い合わせ site:com']
