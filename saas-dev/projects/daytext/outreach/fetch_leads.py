"""
通所介護事業所（デイサービス）リードをBrave APIで収集
...
SITE_SKIP = ["wikipedia", "google", "yahoo", "twitter", "facebook", "instagram",
             ...
             "kaigonavi", "kaigo-abc", "kaigodb"]

_COMPANY_KEYWORDS = ["デイサービス", "通所介護", "介護センター", "ケアセンター", "通所", "デイ"]

QUERIES = [
    '通所介護事業所 "お問い合わせ" site:co.jp -求人',
    'デイサービス "メールでのお問い合わせ" -採用 -求人',
    '通所介護 "info@" site:co.jp -ランキング',
    'デイサービス "お問い合わせ" 機能訓練 -一覧 -比較',
    '通所介護事業所 "contact@" site:co.jp',
    'デイサービス 個別機能訓練 "メール" -求人 -ランキング',
    '通所介護 東京 "お問い合わせ" site:co.jp -求人',
    'デイサービス 大阪 "info@" -採用',
    '通所介護 名古屋 "メール" site:co.jp',
    'デイサービス 神奈川 "お問い合わせ" -求人',
    '通所介護 福岡 "contact@" site:co.jp',
    'デイサービス 埼玉 "info@" -採用 -一覧',
    '通所介護事業所 リハビリ "お問い合わせ" site:co.jp',
    'デイサービス 機能訓練指導員 "メール" -求人',
    '通所介護 認知症対応 "お問い合わせ" -ランキング',
    'デイサービス 入浴介助 "info@" site:co.jp',
    '通所介護 生活相談員 "メールアドレス" -求人',
    'デイサービス 高齢者 "お問い合わせ" site:co.jp -まとめ',
    '通所介護事業所 "ご連絡" "メール" -求人 -一覧',
    'デイサービス 小規模 "お問い合わせ" site:co.jp',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; DayTextBot/1.0)"})
