"""
yurohokentext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['有料老人ホーム', '介護', 'シニア', 'ケア', 'レジデンス', 'ホーム', 'ライフ', '福祉']

QUERIES = ['有料老人ホーム 運営会社 "お問い合わせ" site:co.jp -求人', '介護施設 法人 "info@" site:jp -採用', 'シニアレジデンス "メールアドレス" -転職', '有料老人ホーム 施設長 "連絡先" site:or.jp', '介護付き有料老人ホーム 事務長 "お問い合わせ" -採用', '住宅型有料老人ホーム 経営 "メール" -求人', 'サービス付き高齢者向け住宅 "担当者" "連絡先" -募集', '有料老人ホーム 経営者 "お問い合わせフォーム" -採用', '介護事業所 "法人問い合わせ" site:co.jp', '老人ホーム 事務部門 "連絡先" -転職', '有料老人ホーム 運営法人 "メール" site:co.jp -採用', '介護施設 運営会社 "info@" site:jp -求人', 'シニア向け住宅 "お問い合わせ" -採用', '有料老人ホーム 施設概要 "連絡先" -求人', '介護サービス事業所 "お問い合わせ" メール -募集']
