"""
suisantext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['水産', '漁業', '加工', '食品', '冷凍', '冷蔵', '鮮魚', '養殖', 'フーズ', '物産', '漁協']

QUERIES = ['水産加工業者 "お問い合わせ" site:co.jp -求人 -採用 -転職', '水産物加工 "連絡先" site:jp -求人 -採用 -転職', '鮮魚加工 "問い合わせ" site:co.jp -求人 -採用 -転職', '冷凍食品製造 "連絡先" site:jp -求人 -採用 -転職', '水産加工会社 "メールアドレス" site:co.jp -求人 -採用 -転職', 'HACCP導入 水産加工 "連絡先" site:jp -求人 -採用 -転職', 'アレルゲン管理 水産加工 "問い合わせ" site:co.jp -求人 -採用 -転職', '品質管理 水産加工 "連絡先" site:jp -求人 -採用 -転職', '水産加工工場 "連絡先" site:co.jp -求人 -採用 -転職', '水産加工業 衛生管理 "問い合わせ" site:jp -求人 -採用 -転職', '魚介類加工 "お問い合わせ" site:co.jp -求人 -採用 -転職', '水産食品製造 "連絡先" site:jp -求人 -採用 -転職', '水産加工品 "問い合わせ先" site:co.jp -求人 -採用 -転職', '水産加工業 経営者 "連絡先" site:jp -求人 -採用 -転職', '水産加工 業務効率化 "問い合わせ" site:co.jp -求人 -採用 -転職']
