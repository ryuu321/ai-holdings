"""
pettotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['ペット', '動物', '犬', '猫', 'トリミング', 'サロン', 'ホテル', 'ブリーダー', '動物病院', 'アニマル']

QUERIES = ['ペットショップ お問い合わせ メール site:co.jp -求人 -採用', 'ペットサロン 連絡先 メール site:co.jp -求人 -採用', 'トリミングサロン 問い合わせ メールアドレス site:co.jp -求人 -採用', '動物病院 お問い合わせ メール site:co.jp -求人 -採用', 'ペットホテル お問い合わせ メール site:co.jp -求人 -採用', 'ドッグカフェ 問い合わせ メール site:co.jp -求人 -採用', 'キャットカフェ 問い合わせ メール site:co.jp -求人 -採用', 'ペット用品店 お問い合わせ メール site:co.jp -求人 -採用', 'ブリーダー 問い合わせ メールアドレス site:co.jp -求人 -採用', '老犬ホーム お問い合わせ メール site:co.jp -求人 -採用', 'ペットシッター 問い合わせ メール site:co.jp -求人 -採用', 'ペット葬儀 問い合わせ メール site:co.jp -求人 -採用', '犬の幼稚園 問い合わせ メール site:co.jp -求人 -採用', '猫カフェ 問い合わせ メール site:co.jp -求人 -採用', 'ペットショップ 採用情報 メール site:co.jp -求人']
