"""
sekizaitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['石材', '墓石', '石工', '霊園', '供養', '墓地']

QUERIES = ['石材店 連絡先 site:co.jp -求人', '墓石業者 問い合わせ site:co.jp -採用', '霊園 管理事務所 メールアドレス -転職', '石材工事 会社 連絡先 -募集', '墓じまい 専門業者 問い合わせ', '永代供養 相談 会社 メール', '石材加工 業者 連絡先', '墓石リフォーム 業者 問い合わせ', 'お墓の相談 会社 連絡先', '石材店 見積もり 問い合わせ', '墓地 造成 業者 連絡先', '石材販売 会社 問い合わせ', '石材彫刻 業者 連絡先', '石材設計 会社 問い合わせ', 'お墓の引越し 業者 連絡先']
