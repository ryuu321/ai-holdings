"""
sogitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['葬儀', 'セレモニー', 'フューネラル', '葬祭', '会館', '斎場', '供養']

QUERIES = ['"葬儀社" "お問い合わせ" site:co.jp -求人 -採用', '"葬儀会館" "メールアドレス" site:jp -転職 -募集', '"セレモニーホール" "連絡先" site:or.jp -アルバイト', '"フューネラル" "資料請求" site:jp -比較 -ランキング', '"葬祭業" "お問い合わせフォーム" site:co.jp -ブログ', '"葬儀社" "info@" site:jp -採用情報', '"家族葬専門" "お問い合わせ" site:co.jp -求人', '"一日葬" "連絡先" site:jp -募集', '"直葬" "メール" site:co.jp -ブログ', '"葬儀サービス" "お問い合わせ" site:jp -求人 -転職', '"葬儀社" "代表メール" site:co.jp', '"葬儀" "法人向け" "お問い合わせ" site:jp', '"葬儀社" "事業所" "連絡先" site:co.jp', '"葬儀" "経営者" "お問い合わせ" site:jp', '"メモリアルホール" "お問い合わせ" site:co.jp -求人']
