"""
juitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['動物病院', 'アニマルクリニック', '獣医科', 'ペットクリニック', '動物医療センター']

QUERIES = ['"動物病院" "お問い合わせ" site:co.jp -求人 -採用', '"獣医" "メールアドレス" site:jp -転職 -募集', '"アニマルクリニック" "連絡先" site:co.jp -求人 -採用情報', '"ペットクリニック" "お問い合わせフォーム" site:jp -募集 -採用', '"総合動物病院" "代表メール" site:co.jp -求人 -採用', '"動物医療センター" "お問い合わせ" site:jp -求人 -採用', '"地域名 動物病院" "メール" site:co.jp', '"獣医師会" "会員病院" "お問い合わせ" site:jp', '"動物病院" "院長" "メール" site:jp', '"動物病院" "事務長" "連絡先" site:co.jp', '"動物病院" "業務改善" "お問い合わせ" site:jp', '"動物病院" "書類作成" "効率化" "お問い合わせ" site:co.jp', '"獣医療" "IT導入" "相談" site:jp', '"動物病院" "経営" "問い合わせ" site:co.jp', '"動物病院" "パートナー募集" "連絡先" site:jp']
