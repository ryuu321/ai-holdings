"""
sokuryotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['測量', '土地家屋調査士', '測量設計', '測量事務所', '測量法人']

QUERIES = ['測量会社 問い合わせ site:co.jp -求人 -採用', '測量事務所 連絡先 site:jp -転職', '土地家屋調査士事務所 メールアドレス site:co.jp', '測量設計 協力会社 募集 site:jp -求人', '測量依頼 相談 連絡先 site:co.jp', '境界確定測量 見積もり 問い合わせ site:jp', '不動産測量 業務提携 site:co.jp', '公共測量 問い合わせ先 site:jp', '開発許可申請 測量 連絡先 site:co.jp', '測量コンサルタント 問い合わせ site:jp', '測量法人 連絡先 site:co.jp -採用', '測量士事務所 業務案内 メール site:jp', '測量サービス 提供会社 問い合わせ site:co.jp', '測量技術者 募集 ではなく 業務依頼 site:jp', '測量会社 顧問契約 問い合わせ site:co.jp']
