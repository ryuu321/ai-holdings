"""
fukushitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['社会福祉法人', '福祉会', '特別養護老人ホーム', '障害者支援施設', '放課後等デイサービス', '児童発達支援', '地域包括支援センター', '福祉事業所']

QUERIES = ['社会福祉法人 "お問い合わせ" site:or.jp -求人', '社会福祉法人 "info@" site:or.jp -採用', '特別養護老人ホーム "連絡先" site:jp -転職', '障害者支援施設 "メールアドレス" site:co.jp -募集', '放課後等デイサービス "お問い合わせ" site:or.jp -アルバイト', '児童発達支援 "info@" site:jp -パート', '地域包括支援センター "お問い合わせ" site:go.jp -職員', '社会福祉法人 "事務長" "メール" site:or.jp', '社会福祉法人 "施設長" "連絡先" site:jp', '社会福祉法人 "業務改善" "お問い合わせ" site:or.jp', '社会福祉法人 "記録業務" "効率化" site:jp', '社会福祉法人 "書類作成" "支援" site:or.jp', '社会福祉法人 "管理者" "連絡先" site:co.jp', '社会福祉法人 "相談支援" "お問い合わせ" site:or.jp', '社会福祉法人 "サービス計画" "担当" site:jp']
