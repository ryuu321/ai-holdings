"""
fukushitext アウトリーチ送信スクリプト（Gmail SMTP・30件/日）
"""
import argparse
import csv
import os
...
_COMPANY_REQUIRED = ['社会福祉法人', '福祉会', '特別養護老人ホーム', '障害者支援施設', '放課後等デイサービス', '児童発達支援', '地域包括支援センター', '福祉事業所']
_BLOG_SIGNALS = ['コツ', '選び方', 'ランキング', '比較', 'まとめ', '一覧', '営業リスト', '業務改善', '効率化', '負担軽減']
