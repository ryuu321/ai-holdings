"""
zoentext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['造園', '緑化', '庭園', 'ランドスケープ', '植木', '外構', 'エクステリア']

QUERIES = ['造園会社 問い合わせ site:co.jp -求人 -採用', '緑化工事 連絡先 site:jp -転職 -募集', '庭園設計 会社概要 site:com -ブログ', '造園業 メールアドレス site:co.jp -求人情報', '緑化事業 お問い合わせフォーム site:jp -採用情報', 'ランドスケープデザイン 連絡先 site:com -キャリア', '屋上緑化 会社名 site:co.jp -アルバイト', '壁面緑化 問い合わせ先 site:jp -パート', '公園緑化 企業情報 site:com -新卒', '造園施工 連絡先 site:co.jp -リクルート', '外構工事 問い合わせ site:jp -募集要項', '植栽工事 会社概要 site:com -採用ページ', '樹木医 事務所 連絡先 site:co.jp -求人募集', 'ガーデンデザイン 問い合わせ site:jp -採用情報', 'エクステリア工事 連絡先 site:com -求人情報']
