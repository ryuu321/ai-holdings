"""
nokitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['農機', 'アグリ', 'サービス', '修理', '整備', '販売']

QUERIES = ['農業機械修理業者 "お問い合わせ" site:co.jp -求人', '農機具修理 "連絡先" site:co.jp -採用', 'トラクター修理 "メールアドレス" site:jp -転職', 'コンバイン修理 "見積もり依頼" site:co.jp -募集', '田植え機修理 "サービス内容" site:jp -求人', '農業機械整備 "お問い合わせフォーム" site:co.jp -採用', '農機具点検 "電話番号" site:jp -転職', '農業機械販売修理 "お問い合わせ" site:co.jp -求人', '中古農機具修理 "連絡先" site:jp -採用', '地域名 農業機械修理 "お問い合わせ" site:co.jp -求人', '農業機械メンテナンス "メール" site:jp -転職', '農業機械故障 "お問い合わせ" site:co.jp -求人', '農機具トラブル "連絡先" site:jp -採用', '農業機械サービス "見積もり" site:co.jp -募集', '農業機械修理専門店 "お問い合わせ" site:jp -求人']
