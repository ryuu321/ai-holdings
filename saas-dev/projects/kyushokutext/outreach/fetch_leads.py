"""
kyushokutext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['給食', 'フードサービス', 'メディカル', 'ヘルスケア', '食事サービス', 'ケータリング', '委託給食']

QUERIES = ['給食受託会社 "お問い合わせ" site:co.jp -求人', '給食受託会社 "info@" -採用', '給食受託会社 "メールでのお問い合わせ" -転職', '給食サービス 委託 "連絡先" site:co.jp', '病院給食 委託 "お問い合わせ" site:jp', '高齢者施設 給食 契約 "メールアドレス"', '保育園 給食 外部委託 "問い合わせ"', '社員食堂 運営委託 "お問い合わせフォーム"', '給食事業 "法人向け" "連絡先"', '給食管理システム 導入事例 "問い合わせ"', '給食受託 業務提携 "お問い合わせ"', '給食会社 "パートナー募集" "連絡先"', '給食サービス 導入検討 "お問い合わせ"', '給食受託企業 "資料請求" "メール"', '給食業務請負 "お問い合わせ" site:or.jp']
