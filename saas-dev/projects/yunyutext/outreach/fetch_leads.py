"""
yunyutext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['輸入', '貿易', 'フーズ', 'グローバル', 'インターナショナル', '商事', '物産', '食品']

QUERIES = ['輸入食品卸業者 "お問い合わせ" site:co.jp -求人', '輸入食品卸業者 "info@" -採用', '輸入食品卸業者 "メールでのお問い合わせ" -転職', '食品輸入 会社 "連絡先" site:co.jp', '海外食品 卸 "お問い合わせ" site:jp', '輸入食材 専門商社 "メール" -採用', '食品貿易 企業 "お問い合わせフォーム" site:co.jp', '輸入菓子 卸売 "info" site:jp', '輸入ワイン 卸 "連絡先" -求人', '輸入調味料 卸 "お問い合わせ" site:co.jp', '輸入食品 販売 "担当者" -転職', '食品原料 輸入 "お問い合わせ" site:jp', '海外農産物 卸 "メールアドレス" -採用', '輸入食品 安全管理 "問い合わせ" site:co.jp', '輸入食品 品質保証 "連絡先" site:jp']
