"""
kensetsuconstext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['建設コンサルタント', '土木設計', '建築コンサルティング', '測量設計', '地質調査', '都市計画', '環境コンサルタント', '構造設計']

QUERIES = ['建設コンサルタント会社 "お問い合わせ" site:co.jp -求人', '建設コンサルタント会社 "contact" site:co.jp -採用', '建設コンサルタント "メールアドレス" site:co.jp -募集', '建設コンサルタント "代表メール" site:jp -転職', '建設コンサルタント "info@" site:co.jp -採用情報', '土木設計コンサルタント "お問い合わせ" site:co.jp', '建築コンサルティング "連絡先" site:co.jp', '測量設計事務所 "メール" site:jp', '地質調査会社 "お問い合わせフォーム" site:co.jp', '都市計画コンサルタント "代表連絡先" site:co.jp', '環境コンサルタント "お問い合わせ" site:jp', '建設コンサルタント協会 会員企業 "お問い合わせ" site:co.jp', '建設コンサルタント "事業内容" "お問い合わせ" site:co.jp', '道路設計 コンサルタント "連絡先" site:co.jp', '河川計画 コンサルタント "お問い合わせ" site:jp']
