"""
特別養護老人ホーム・老健施設リードをBrave APIで収集
...
SITE_SKIP = ["wikipedia", "google", "yahoo", "twitter", "facebook", "instagram",
             ...
             "kaigo-guide.jp", "kaigonomimaki.net", "kaigo.homes.co.jp", "mhlw.go.jp"]

_COMPANY_KEYWORDS = ["特別養護", "老人ホーム", "老健", "特養", "介護老人", "ケアホーム", "デイサービス"]

QUERIES = [
    '特別養護老人ホーム "お問い合わせ" site:co.jp -求人',
    '特養 "メールでのお問い合わせ" -採用',
    '介護老人保健施設 "info@" site:co.jp',
    '老人ホーム "お問い合わせ" -ランキング -一覧 site:co.jp',
    '特養 "メール" -求人 site:co.jp',
    '老健 "contact" -採用',
    '特別養護老人ホーム "お問い合わせ" -比較 -選び方',
    '介護施設 "メールアドレス" site:co.jp -比較',
    '特養 東京 "info@" -求人',
    '老人ホーム 大阪 "お問い合わせ" site:co.jp',
    '特養 名古屋 "メール" -採用',
    '老健 福岡 "お問い合わせ"',
    '特別養護 神奈川 "contact@"',
    '老人ホーム 埼玉 "info@" site:co.jp',
    '特養 社会福祉法人 "お問い合わせ" site:or.jp',
    '介護老人保健施設 "メール" site:or.jp',
    '特別養護老人ホーム 社会福祉法人 "info@"',
    '老健 医療法人 "お問い合わせ" site:co.jp',
    '特養 "施設長" "お問い合わせ"',
    '介護施設 "ケアマネ" "お問い合わせ" site:co.jp',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; TokuTextBot/1.0)"})
