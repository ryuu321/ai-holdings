"""
fctext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['フランチャイズ', 'FC', 'チェーン', '多店舗', '本部']

QUERIES = ['フランチャイズ本部 連絡先 site:co.jp -求人 -採用 -転職', 'FC本部 問い合わせ メール site:co.jp -求人 -採用 -転職', 'チェーン展開 企業 連絡先 site:co.jp -求人 -採用 -転職', '多店舗展開 企業 問い合わせ site:co.jp -求人 -採用 -転職', 'フランチャイズシステム 運営会社 連絡先 site:co.jp -求人 -採用 -転職', 'FC事業 展開企業 問い合わせ site:co.jp -求人 -採用 -転職', 'フランチャイズ加盟店 募集本部 連絡先 site:co.jp -求人 -採用 -転職', '本部機能 強化 企業 問い合わせ site:co.jp -求人 -採用 -転職', 'フランチャイズ経営 支援会社 連絡先 site:co.jp -求人 -採用 -転職', 'FCブランド 運営会社 問い合わせ site:co.jp -求人 -採用 -転職', '飲食フランチャイズ本部 連絡先 site:co.jp -求人 -採用 -転職', '小売フランチャイズ本部 問い合わせ site:co.jp -求人 -採用 -転職', 'サービス業フランチャイズ本部 連絡先 site:co.jp -求人 -採用 -転職', '教育フランチャイズ本部 問い合わせ site:co.jp -求人 -採用 -転職', '美容フランチャイズ本部 連絡先 site:co.jp -求人 -採用 -転職']
