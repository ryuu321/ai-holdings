"""
ihintext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['遺品整理', '特殊清掃', '生前整理', '終活', 'ごみ屋敷', '空き家整理', '不用品回収']

QUERIES = ['遺品整理業者 "お問い合わせ" site:co.jp -求人', '遺品整理 "info@" -採用', '遺品整理会社 "メールでのお問い合わせ" -転職', '特殊清掃業者 "連絡先" site:jp', '生前整理 "お問い合わせフォーム" site:co.jp', '終活サポート "メールアドレス" -ブログ', '遺品整理士 "連絡先" site:co.jp -講座', '遺品整理 "見積もり依頼" "メール" -個人', '遺品整理 "法人向け" "お問い合わせ" site:jp', '遺品整理 "提携募集" "メール" -フランチャイズ', '遺品整理 "パートナー募集" "お問い合わせ" site:co.jp', '遺品整理 "事業内容" "連絡先" -求人', '遺品整理 "サービス内容" "メール" -比較', '遺品整理 "会社概要" "お問い合わせ" site:jp', '遺品整理 "料金体系" "メール" -ランキング']
