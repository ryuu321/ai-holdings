"""
gyogyotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['水産', '漁業', '養殖', '定置網', '漁協', 'マリン']

QUERIES = ['水産会社 お問い合わせ site:co.jp -求人', '養殖場 連絡先 site:jp -採用', '定置網漁業 会社情報 site:co.jp -転職', '漁業協同組合 お問い合わせ site:jp -募集', '水産物加工会社 info@ site:co.jp', '漁業法人 採用情報 site:jp -求人', 'カキ養殖 お問い合わせ site:co.jp -バイト', '真鯛養殖 連絡先 site:jp -アルバイト', '水産流通 企業情報 site:co.jp', '漁業経営者 連絡先 site:jp', '漁業生産者 お問い合わせ site:co.jp -パート', '水産資源管理 会社 site:jp', '漁業DX 導入事例 site:co.jp', '養殖業 業務効率化 相談 site:jp', '漁業日誌 デジタル化 サービス site:co.jp']
