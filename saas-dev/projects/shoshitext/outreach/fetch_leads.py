...
SITE_SKIP = ["wikipedia", "google", "yahoo", "twitter", "facebook", "instagram",
             ...
             "shiho-shoshi.or.jp", "touki.or.jp"]

_COMPANY_KEYWORDS = ["司法書士", "司法書士事務所", "司法書士法人"]

QUERIES = [
    '司法書士事務所 "お問い合わせ" site:co.jp -求人',
    '司法書士 "メールでのお問い合わせ" -採用 -求人',
    '司法書士法人 "info@" site:co.jp',
    '司法書士事務所 不動産登記 "お問い合わせ" -ランキング',
    '司法書士 相続登記 "メール" -求人',
    '司法書士 抵当権抹消 "お問い合わせ" site:co.jp',
    '司法書士 商業登記 "contact" -採用',
    '司法書士 遺産分割 "メールアドレス"',
    '司法書士事務所 東京 "info@" -求人',
    '司法書士 大阪 "お問い合わせ" site:co.jp',
    '司法書士法人 名古屋 "メール" -採用',
    '司法書士 福岡 "お問い合わせ" site:co.jp',
    '司法書士 神奈川 "contact@" -求人',
    '司法書士 埼玉 "info@" site:co.jp',
    '司法書士 売買登記 "お問い合わせ"',
    '司法書士 贈与登記 "メール" -ランキング',
    '司法書士 法人設立登記 "お問い合わせ"',
    '司法書士 成年後見 "info@"',
    '司法書士 債務整理 "メール" site:co.jp',
    '司法書士事務所 開業 "お問い合わせ" -一覧',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; ShoshiTextBot/1.0)"})
