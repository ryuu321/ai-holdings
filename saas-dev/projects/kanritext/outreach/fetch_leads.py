...
SITE_SKIP = ["wikipedia", "google", "yahoo", "twitter", "facebook", "instagram",
             ...
             "suumo", "homes", "athome", "chintai", "lifull"]

_COMPANY_KEYWORDS = ["不動産管理", "賃貸管理", "建物管理", "プロパティ", "管理株式会社", "管理有限会社"]

QUERIES = [
    '不動産管理会社 "お問い合わせ" site:co.jp -求人',
    '賃貸管理 "メールでのお問い合わせ" -採用 -求人',
    '不動産管理 "info@" site:co.jp -ランキング',
    '建物管理 "お問い合わせ" -一覧 -比較',
    '不動産管理会社 "contact@" site:co.jp',
    '賃貸管理 "メール" 管理委託 -求人 -ランキング',
    '不動産管理 東京 "お問い合わせ" site:co.jp -求人',
    '賃貸管理 大阪 "info@" -採用',
    '不動産管理会社 名古屋 "メール" site:co.jp',
    '建物管理 神奈川 "お問い合わせ" -求人',
    '不動産管理 福岡 "contact@" site:co.jp',
    '賃貸管理 埼玉 "info@" -採用 -一覧',
    '不動産管理会社 "管理委託" "お問い合わせ" site:co.jp',
    'プロパティマネジメント "メール" -求人',
    '不動産管理 入退去 "お問い合わせ" -ランキング',
    '賃貸管理 修繕 "info@" site:co.jp',
    '不動産管理会社 "ご連絡" "メール" site:co.jp -まとめ',
    '建物管理 オーナー "お問い合わせ" -一覧',
    '不動産管理 "info@" site:co.jp -求人',
    '賃貸管理会社 "お問い合わせ" site:co.jp',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; KanriTextBot/1.0)"})
