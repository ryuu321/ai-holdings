"""
nougyotext アウトリーチ送信スクリプト（Gmail SMTP・30件/日）
"""
import argparse
import csv
import os
...
_COMPANY_REQUIRED = ['農業', '農園', 'ファーム', '生産', 'アグリ', '協同組合', '農場']
_BLOG_SIGNALS = ['書類作成 コツ', 'GAP認証 取得', '農薬使用記録 方法', '収穫報告書 書き方', '農業 業務効率化', 'スマート農業 導入事例']
