"""
nougyotext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['農業', '農園', 'ファーム', '生産', 'アグリ', '協同組合', '農場']

QUERIES = ['"農業法人" "お問い合わせ" site:co.jp -求人 -採用', '"農園" "連絡先" site:jp -販売 -直売', '"生産組合" "info@" -求人 -JA', '"農業生産法人" "メールアドレス" site:co.jp -募集', '"GAP認証" "お問い合わせ" site:jp -コンサルティング', '"大規模農業" "連絡先" site:co.jp -機械', '"施設園芸" "お問い合わせ" site:jp -求人', '"露地栽培" "メール" site:co.jp -販売', '"米作法人" "お問い合わせ" site:jp -個人', '"野菜生産法人" "連絡先" site:co.jp -レシピ', '"果樹生産法人" "info@" site:jp -観光', '"スマート農業" "お問い合わせ" site:co.jp -イベント', '"農業DX" "連絡先" site:jp -ソリューション', '"農業経営" "お問い合わせ" site:co.jp -セミナー', '"農業記録" "お問い合わせ" site:co.jp -アプリ']
