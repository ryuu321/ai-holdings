...
SITE_SKIP = ["wikipedia", "google", "yahoo", "twitter", "facebook", "instagram",
             ...
             "med.or.jp", "mhlw.go.jp", "hospital-finder"]

_COMPANY_KEYWORDS = ["クリニック", "内科", "外科", "診療所", "医院", "医療法人"]

QUERIES = [
    '内科クリニック "お問い合わせ" site:co.jp -求人',
    '外科クリニック "メールでのお問い合わせ" -採用',
    '内科外科クリニック "info@" site:co.jp',
    '診療所 内科 "お問い合わせ" -ランキング -一覧',
    'クリニック 内科 "メール" -求人 site:co.jp',
    '医療法人 内科クリニック "contact" -採用',
    '在宅医療 クリニック "お問い合わせ" site:co.jp',
    '一般内科 クリニック "メールアドレス" -比較',
    '内科クリニック 東京 "info@" -求人',
    '内科 外科 クリニック 大阪 "お問い合わせ" site:co.jp',
    '内科クリニック 名古屋 "メール" -採用',
    '内科 クリニック 福岡 "お問い合わせ"',
    'クリニック 内科外科 神奈川 "contact@"',
    '内科クリニック 埼玉 "info@" site:co.jp',
    '消化器内科 クリニック "お問い合わせ" -一覧',
    '循環器内科 クリニック "メール" site:co.jp',
    '整形外科クリニック "お問い合わせ" -ランキング',
    '外科クリニック 一般外科 "info@"',
    '内科 外科 診療所 "お問い合わせ" site:co.jp',
    'クリニック 院長 "メールでのお問い合わせ" -一覧',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; IinTextBot/1.0)"})
