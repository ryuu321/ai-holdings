"""
shindantext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['診断士', 'コンサルティング', '経営支援', '事務所', '税理士法人', '行政書士法人', 'コンサルタント']

QUERIES = ['中小企業診断士事務所 "お問い合わせ" site:co.jp -求人', '中小企業診断士事務所 "info@" -採用', '中小企業診断士事務所 "メールでのお問い合わせ" -転職', '経営コンサルティング "お問い合わせ" site:co.jp -求人', '経営診断 "メールアドレス" site:jp', '補助金申請代行 "お問い合わせ" site:co.jp', '事業再生支援 "連絡先" site:jp', '中小企業支援 "お問い合わせフォーム" site:co.jp', '経営改善計画 "相談" "メール" site:jp', 'コンサルタント事務所 "お問い合わせ" site:co.jp -求人', '税理士 中小企業診断士 "お問い合わせ" site:jp', '行政書士 中小企業診断士 "お問い合わせ" site:jp', '経営戦略策定 "お問い合わせ" site:co.jp', '事業承継支援 "お問い合わせ" site:jp', '創業支援 "お問い合わせ" site:co.jp']
