"""
phototext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['フォト', '写真館', 'スタジオ', 'ウェディング', '記念', '出張撮影']

QUERIES = ['写真館 お問い合わせ site:co.jp -求人 -採用', 'フォトスタジオ 連絡先 site:jp -募集', 'ウェディングフォト 問い合わせメール site:co.jp', '家族写真 スタジオ 予約 site:jp -アルバイト', '七五三 撮影 問い合わせ site:co.jp', '宣材写真 スタジオ 連絡先 site:jp', '出張撮影 サービス 問い合わせ site:co.jp', '法人向け 写真撮影 問い合わせ site:jp', '写真スタジオ 法人契約 連絡先 site:co.jp', '記念写真館 問い合わせフォーム site:jp', '学校写真 撮影業者 連絡先 site:co.jp', 'イベント撮影 業者 問い合わせ site:jp', '広告写真 撮影会社 連絡先 site:co.jp', '商品撮影 サービス 問い合わせ site:jp', '写真スタジオ 業務提携 連絡先 site:co.jp']
