...
SITE_SKIP = ["wikipedia", "google", "yahoo", "twitter", "facebook", "instagram",
             ...
             "juku-search", "jukusagashi"]

_COMPANY_KEYWORDS = ["学習塾", "個別指導", "進学塾", "塾", "学院", "スクール", "アカデミー"]

QUERIES = [
    '学習塾 "お問い合わせ" site:co.jp -求人',
    '個別指導塾 "メールでのお問い合わせ" -採用',
    '進学塾 "info@" site:co.jp',
    '学習塾 "お問い合わせ" -ランキング -一覧',
    '個別指導 "メール" -求人 site:co.jp',
    '学習塾 小学生 中学生 "contact" -採用',
    '学習塾 高校受験 "お問い合わせ"',
    '個別指導塾 "メールアドレス" -比較',
    '学習塾 東京 "info@" -求人',
    '個別指導塾 大阪 "お問い合わせ" site:co.jp',
    '学習塾 名古屋 "メール" -採用',
    '学習塾 福岡 "お問い合わせ"',
    '個別指導塾 神奈川 "contact@"',
    '学習塾 埼玉 "info@" site:co.jp',
    '学習塾 中学受験 "お問い合わせ" -一覧',
    '個別指導 高校受験 "メール" site:co.jp',
    '学習塾 大学受験 "お問い合わせ" site:co.jp',
    '家庭教師センター "info@" -求人',
    '学習塾 "塾長" "お問い合わせ"',
    '個別指導学院 "メールでのお問い合わせ" site:co.jp',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; JukuTextBot/1.0)"})
