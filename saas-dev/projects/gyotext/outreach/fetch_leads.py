...
_COMPANY_KEYWORDS = ["行政書士", "行政書士事務所", "行政書士法人"]

QUERIES = [
    '行政書士事務所 "お問い合わせ" site:co.jp -求人',
    '行政書士 "メールでのお問い合わせ" -採用 -求人',
    '行政書士法人 "info@" site:co.jp',
    '行政書士事務所 許認可 "お問い合わせ" -ランキング',
    '行政書士 建設業許可 "メール" -求人',
    '行政書士 在留資格 "お問い合わせ" site:co.jp',
    '行政書士 法人設立 定款 "contact" -採用',
    '行政書士 帰化申請 "メールアドレス"',
    '行政書士事務所 東京 "info@" -求人',
    '行政書士 大阪 "お問い合わせ" site:co.jp',
    '行政書士法人 名古屋 "メール" -採用',
    '行政書士 福岡 "お問い合わせ" site:co.jp',
    '行政書士 神奈川 "contact@" -求人',
    '行政書士 埼玉 "info@" site:co.jp',
    '行政書士 古物商許可 "お問い合わせ"',
    '行政書士 飲食業許可 "メール" -ランキング',
    '行政書士 介護 許可 "お問い合わせ"',
    '行政書士 補助金申請 "info@"',
    '行政書士 相続 遺言 "メール" site:co.jp',
    '行政書士事務所 開業 "お問い合わせ" -一覧',
]
...
def _fetch_html(url: str) -> str:
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0 (compatible; GyoTextBot/1.0)"})
