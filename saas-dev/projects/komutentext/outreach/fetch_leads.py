"""
komutentext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['工務店', '建設', '建築', '住宅', 'ホーム', 'ハウス', '住まい', '工房', '設計', '木造', '注文住宅', 'リフォーム', 'リノベーション']

QUERIES = ['工務店 お問い合わせ site:co.jp -求人', '木造住宅 建設会社 連絡先 site:jp -採用', '注文住宅 施工会社 メールアドレス site:co.jp -転職', 'リフォーム会社 問い合わせフォーム site:jp -ランキング', '地域密着型工務店 連絡先 site:co.jp -比較', '新築工事 相談 メール site:jp -ブログ', '住宅設計事務所 問い合わせ site:co.jp -まとめ', '工務店 会社概要 連絡先 site:jp -一覧', '建築工務店 info@ site:co.jp -募集', '木材工務店 問い合わせ先 site:jp -資料請求', '地域工務店 連絡先 site:co.jp -セミナー', '住宅建築 会社名 メール site:jp -イベント', 'リノベーション 専門会社 連絡先 site:co.jp -パートナー', '自然素材の家 工務店 問い合わせ site:jp -フランチャイズ', '耐震住宅 建設業者 連絡先 site:co.jp -メディア']
