"""
keibitext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['施設警備', '常駐警備', '機械警備', '交通誘導', 'イベント警備', '巡回警備']

QUERIES = ['警備会社 "お問い合わせ" site:co.jp -求人', '警備会社 "info@" -採用', '警備会社 "メールでのお問い合わせ" -転職', '施設警備 "連絡先" site:co.jp', 'イベント警備 "問い合わせ" site:jp', '交通誘導警備 "メールアドレス" -募集', '常駐警備 "お問い合わせフォーム" site:co.jp', '機械警備 "連絡先" -求人', '警備業務 "資料請求" site:co.jp', '警備サービス "見積もり" site:jp', '警備会社 東京 "お問い合わせ" -採用', '警備会社 大阪 "info@" -求人', '警備会社 名古屋 "メールでのお問い合わせ" -転職', '警備会社 福岡 "連絡先" site:co.jp', '警備会社 札幌 "問い合わせ" site:jp']
