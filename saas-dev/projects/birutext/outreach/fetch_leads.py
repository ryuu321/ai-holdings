"""
birutext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['ビル', 'メンテナンス', '管理', '清掃', '設備', 'プロパティ', 'ファシリティ', '総合', '環境', '衛生']

QUERIES = ['"ビルメンテナンス会社" "お問い合わせ" site:co.jp -求人 -採用', '"設備管理会社" "info@" site:co.jp -転職 -募集', '"清掃会社" "メールアドレス" site:co.jp -求人 -パート', '"プロパティマネジメント" "連絡先" site:co.jp -採用情報', '"ファシリティマネジメント" "お問い合わせフォーム" site:co.jp -リクルート', '"総合ビル管理" "お問い合わせ" site:jp -求人 -採用', '"マンション管理会社" "info@" site:jp -転職 -募集', '"オフィスビル管理" "メールでのお問い合わせ" site:jp -採用情報', '"商業施設管理" "連絡先" site:jp -リクルート', '"病院清掃" "お問い合わせ" site:co.jp -求人', '"ホテルメンテナンス" "info@" site:co.jp -採用', '"学校施設管理" "メール" site:jp -募集', '"工場設備メンテナンス" "お問い合わせ" site:co.jp -転職', '"ビル衛生管理" "連絡先" site:jp -求人', '"ビル設備点検" "お問い合わせ" site:co.jp -採用']
