"""
eventtext GTMリード収集スクリプト（Brave API）
...
_COMPANY_KEYWORDS = ['イベント', '企画', 'プロデュース', '制作', '運営', 'コンサルティング']

QUERIES = ['イベント企画会社 問い合わせ site:co.jp -求人', 'イベントプロデュース 連絡先 site:jp -採用', 'イベント制作会社 担当者 site:com -転職', 'イベント運営 会社概要 site:co.jp -募集', 'イベントコンサルティング メールアドレス site:jp -キャリア', '展示会企画会社 お問い合わせフォーム site:com -アルバイト', '地域活性化イベント 企画会社 連絡先 site:co.jp', '企業イベント 企画 会社名 site:jp', 'MICE イベント 企画 問い合わせ site:com', 'オンラインイベント 制作会社 連絡先 site:co.jp', '周年イベント 企画 会社 連絡先 site:jp', 'イベント運営代行 会社 問い合わせ site:com', 'フェスティバル 企画 会社 連絡先 site:co.jp', 'イベント会場設営 会社 問い合わせ site:jp', 'イベントマーケティング 会社 問い合わせ site:com']
